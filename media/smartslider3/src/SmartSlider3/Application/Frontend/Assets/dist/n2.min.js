! function(t) {
    ...
    var n, r, s = t.document,
        ...
        m = navigator.userAgent.indexOf("+http://www.google.com/bot.html") > -1 ? function(t) {
            t()
    ...
    g((function() {
        ...
        function() {
            ...
            function u() {
                ...
                !i.n2Slow && n.length && (i.n2Slow = !0), n.unshift.apply(n, s), (s = n).length ? m(u, {
                    timeout: 2e3
                }) : o = !1
            }

            function c(t) {
                s.unshift(t), o || (o = !0, m(u, {
                    timeout: 2e3
                }))
            }
            var l = new Date,
            ...
            for (var w = 0; w < this._N2._d.length; w++) h.d.apply(this, this._N2._d[w]);
            for (var y = 0; y < this._N2._r.length; y++) h.r.apply(this, this._N2._r[y])
        ...
        function() {
            ...
            connectedCallback() {
                if (this.isConnected) {
                    n = n || s.body, this.Z = "rtl" === o.getAttribute("dir"), this._width = 0, this._offset = Number.MAX_SAFE_INTEGER, this.V = h.MW.i(this, {
                    ...
                    if (r === n)
                        for (var u = [".elementor-section-stretched", '.siteorigin-panels-stretch[data-stretch-type="full-stretched"]', '.siteorigin-panels-stretch[data-stretch-type="full-stretched-padded"]', ".themify_builder_row.fullwidth", '.vce-row[data-vce-stretch-content="true"]'], f = 0; f < u.length; f++) {
            ...
            doResize() {
                ...
                var o, a, u = r > 0 ? r : n.clientWidth,
                    h = i.getComputedStyle(this.parentNode);
                o = this.Z ? u - this.parentNode.getBoundingClientRect().right - parseInt(h.getPropertyValue("padding-right")) - parseInt(h.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(h.getPropertyValue("padding-left")) - parseInt(h.getPropertyValue("border-left-width")) + t, o += a = o % 1, u -= Math.floor(a), (this._width - u <= 0 || this._width - u > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.V.x = o, this._offset = o, 0 !== o && this.classList.add("n2-ss-no-bga-fixed")), this._width !== u && (this.V.width = u, this._width = u)), this.setVisible && this.setVisible()
            }
            setVisible() {
            ...
            addPromise(t) {
                this.q.push(t), this.syncStyle(), t.finally(this.removePromise.bind(this, t))
            }
            removePromise(t) {
            ...
            syncStyle() {
                this.q.length ? this.H || (this.H = a(this.show.bind(this), 100)) : (this.H && (u(this.H), delete this.H), this.display = "")
            }
        });
    var w, y = "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
    i.n2const = {
        devicePixelRatio: i.devicePixelRatio || 1,
        isFirefox: /Firefox/i.test(navigator.userAgent),
        isIOS: /iPad|iPhone|iPod/.test(navigator.platform) || y,
        isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Silk/i.test(navigator.userAgent) || y,
        ...
        getScrollbarSize: function() {
            var t = f("div");
            t.style.visibility = "hidden", t.style.overflow = "scroll", n.appendChild(t);
            var i = t.offsetHeight - t.clientHeight;
            return n.removeChild(t), n2const.getScrollbarSize = function() {
                return i
            }, i
        },
    ...
    }, i.n2const.isTablet = !i.n2const.isPhone && (/Android|iPad|tablet|Silk/i.test(navigator.userAgent) || y), i.n2const.rtl = (i.n2const.isRTL = function() {
        ...
        right: "right",
        modifier: 1
    }), h._triggerResize = (w = null, function() {
        w && u(w), w = a((function() {
            d(i, "resize"), w = null
        }), 100)
        ...
        s.prototype.addTimeout = function(t) {
            ...
            for (var t = 0; t < this.localListeners.length; t++) this.localListeners[t][0].removeEventListener(this.localListeners[t][1], this.localListeners[t][2], this.localListeners[t][3]);
            var i;
            this.isActive = !1, i = this.el, v(i, new Event("universalleave", {
                bubbles: !1,
                cancelable: !1
            }))
        ...
        return function(u, h) {
            ...
            function C(e, t) {
                if ((e.isPrimary === r || e.isPrimary) && !o && (l = [], x = !0, !k[m = t](e) && !P(e.target)))
                    if (("mousedown" === e.type || "pointerdown" === e.type && "mouse" === e.pointerType) && e.target.closest(".n2-ss-text")) {
                        var i = p(e.target, "click", (function(t) {
                            i(), Math.abs(e.clientX - t.clientX) < 10 && Math.abs(e.clientY - t.clientY) < 10 && d(e.target, "n2click")
                        }));
                        a(i, 2e3)
                    } else o = !0, 0 !== m && l.push(p(s, O[m][1], A, {
                        passive: !1,
                        capture: !0
                    })), l.push(p(s, O[m][2], R, {
                        passive: !1,
            ...
            function A(t) {
                (t.isPrimary === r || t.isPrimary) && ("x" === f.axis && (!f.preventScroll && v || k[m](t)) || P(t.target) || (F(t), (Math.abs(b.x) > 10 || Math.abs(b.y) > 10) && (x = !1), v === r && 2 !== m && (v = Math.abs(b.x) < Math.abs(b.y) && !f.preventScroll) || f.move(t, y, b, g) && f.preventDefault && S(t)))
            }
            ...
            return M.push(p(s, "scroll", (function() {
                i.nextendScrollFocus !== r && i.nextendScrollFocus || (g = !0)
            }))), 1 === _ && (u.style.touchAction = "y" === f.axis ? "pan-x" : "pan-y"), M.push(p(u, O[_][0], (function(e) {
                C(e, _)
            }), {
                passive: !1,
                capture: !0
            })), 0 === _ && M.push(p(u, O[0][1], (function(e) {
                A(e)
            }), {
                passive: !1,
                capture: !0
            })), M.push(p(u, "dragstart", S)), f.mouse && 0 === _ && M.push(p(u, O[2][0], (function(e) {
                C(e, 2)
            }))), M.push(p(u, "click", (function(t) {
                x ? f.click(t) : S(t)
            }))), {
        ...
        ! function(e) {
            ...
            function ut(t, e, i) {
                ...
                if (!d) {
                    if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Pi[t]) d = Pi[t];
                        ...
                        } else a = +d[0] % 360 / 360, u = d[1] / 100, n = 2 * (h = d[2] / 100) - (r = h <= .5 ? h * (u + 1) : h + u - h * u), 3 < d.length && (d[3] *= 1), d[0] = at(a + 1 / 3, n, r), d[1] = at(a, n, r), d[2] = at(a - 1 / 3, n, r);
            ...
            function ft(t, e, i) {
                ...
                if (u = u.map((function(t) {
                    ...
                    for (o = (r = t.replace(Si, "1").split(ri)).length - 1; f < o; f++) a += r[f] + (~n.indexOf(f) ? u.shift() || h + "0,0,0,0)" : (s.length ? s : u.length ? u : i).shift());
                if (!r)
            ...
            var mt, wt, yt, bt, Mt, xt, _t, Ot, kt, Pt, St, Ft, Ct, At, It, Rt, Et, Tt, zt, Dt, Bt, Lt, Xt, Yt, jt, Nt, Qt = {
                    autoSleep: 120,
                    force3D: "auto",
                    nullTargetWarn: 1,
                    units: {
                ...
                Fi = /hsl[a]?\(/,
                Ci = (Et = Date.now, Tt = 500, zt = 33, Dt = Et(), Bt = Dt, Xt = Lt = 1e3 / 240, At = {
                    time: 0,
                    frame: 0,
                    tick: function() {
                        Di(!0)
                    ...
                    wake: function() {
                        _t && (!bt && l() && (yt = bt = i, Mt = yt.document || {}, ui.gsap = gn, (yt.gsapVersions || (yt.gsapVersions = [])).push(gn.version), d(xt || yt.GreenSockGlobals || !yt.gsap && yt || {}), Ct = yt.requestAnimationFrame), St && At.sleep(), Ft = Ct || function(t) {
            ...
            function Qi(t, e, i, n, o, a) {
                ...
                if (li[t] && !1 !== (u = new li[t]).init(o, u.rawVars ? e[t] : function(t, e, i, n, o) {
                        ...
                        return u
                    }(e[t], n, o, a, i), i, n, a) && (i._pt = h = new cn(i._pt, o, t, 0, 1, u.render, u, 0, u.priority), i !== kt))
                    for (c = i._ptLookup[i._targets.indexOf(o)], l = u._props.length; l--;) c[u._props[l]] = h;
                return u
            }
            C(Ni.prototype, {
                _lock: 0,
            ...
            var Ui, Wi = function(t, e, i, n, o, a, u, h, f) {
                    ...
                    if (r(n) && (~n.indexOf("random(") && (n = et(n)), "=" === n.charAt(1) && (n = parseFloat(v) + parseFloat(n.substr(2)) * ("-" === n.charAt(0) ? -1 : 1) + (G(v) || 0))), v !== n) return isNaN(v * n) ? (l || e in t || p(e, n), function(t, e, i, n, r, s, o) {
                        var a, u, h, f, c, l, v, d, p = new cn(this._pt, t, e, 0, 1, on, null, r),
                            g = 0,
                            m = 0;
                ...
                Zi = function t(e, i) {
                    var n, r, s, o, a, u, h, f, l, v, d, p, g, m = e.vars,
                        w = m.ease,
                        b = m.startAt,
                        M = m.immediateRender,
                        x = m.lazy,
                    ...
                    if (!Y || A && w || (w = "none"), e._ease = zi(w, Ut.ease), e._yEase = F ? Ti(zi(!0 === F ? w : F, Ut.ease)) : 0, F && e._yoyo && !e._repeat && (F = e._yEase, e._yEase = e._ease, e._ease = F), !Y) {
                        if (p = (f = D[0] ? y(D[0]).harness : 0) && m[f.prop], n = R(m, hi), T && T.render(-1, !0).kill(), b)
                            if (z(e._startAt = Hi.set(D, C({
                                ...
                                else if (E && !(i < 0 && T)) return void(i && (e._zTime = i))
                        ...
                        for (e._pt = 0, x = E && c(x) || x && !E, r = 0; r < D.length; r++) {
                            if (h = (a = D[r])._gsap || $(D)[r]._gsap, e._ptLookup[r] = v = {}, ci[h.id] && fi.length && k(), d = L === D ? r : L.indexOf(a), f && !1 !== (l = new f).init(a, p || n, e, d, L) && (e._pt = o = new cn(e._pt, a, l.name, 0, 1, l.render, l, 0, l.priority), l._props.forEach((function(t) {
                                    v[t] = o
                                })), l.priority && (u = 1)), !f || p)
                                for (s in n) li[s] && (l = Qi(s, n, e, d, a, L)) ? l.priority && (u = 1) : v[s] = o = Wi.call(e, a, s, "get", n[s], d, L, 0, m.stringFilter);
                ...
                Hi = function(i) {
                    function s(e, t, r, s) {
                        ...
                        var u, h, l, d, p, m, y, b, M = (a = i.call(this, s ? t : E(t), r) || this).vars,
                            _ = M.duration,
                            O = M.delay,
                            k = M.immediateRender,
                            P = M.stagger,
                        ...
                        if (a._targets = z.length ? $(z) : g("GSAP target " + e + " not found. https://greensock.com", !Qt.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = S, F || P || v(_) || v(O)) {
                            if (t = a.vars, (u = a.timeline = new Ni({
                                    data: "nested",
                                    defaults: A || {}
                                })).kill(), u.parent = u._dp = n(a), u._start = 0, F) C(u.vars.defaults, {
                                ease: "none"
                        ...
                        return !0 !== S || mt || (Ui = n(a), wt.killTweensOf(z), Ui = 0), T && j(T, n(a)), (k || !_ && !F && a._start === x(T._time) && c(k) && function t(i) {
                    ...
                    return e.render = function(t, e, i) {
                        var n, r, s, o, a, u, h, f, c, l = this._time,
                            v = this._tDur,
                            d = this._dur,
                        ...
                        var n, s, o, a, u, h, f, c = this._targets,
                            l = t ? xi(t) : c,
                            v = this._ptLookup,
                            d = this._pt;
                        ...
                        for (n = this._op = this._op || [], "all" !== e && (r(e) && (u = {}, M(e, (function(t) {
                            ...
                            if (~l.indexOf(c[f]))
                                for (u in s = v[f], "all" === e ? (n[f] = e, a = s, o = {}) : (o = n[f] = n[f] || {}, a = e), a)(h = s && s[u]) && ("kill" in h.d && !0 !== h.d.kill(u) || T(this, h, "_pt"), delete s[u]), "all" !== o && (o[u] = 1);
                ...
                registerPlugin: function() {
                    ...
                    e.forEach((function(t) {
                        return function(t) {
                            ...
                            if (Ai(), t !== n) {
                                if (li[e]) return;
                                C(n, C(R(t, r), o)), mi(n.prototype, mi(r, R(t, o))), li[n.prop = e] = n, t.targetTest && (pi.push(n), hi[e] = 1), e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
                            }
            ...
            function In() {
                void 0 !== i && i.document && ($n = i.document, Jn = $n.documentElement, tr = Cn("div") || {
                    style: {}
                }, Cn("div"), Cr = Rr(Cr), Ar = Cr + "Origin", tr.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", nr = !!Rr("perspective"), Kn = 1)
            }
            ...
            function Yn(t, e, i, n) {
                ...
                var o, a, u, h, f, c, l, v, d, p, g, m, w = new cn(this._pt, t.style, e, 0, 1, on),
                    y = 0,
                    b = 0;
                if (w.b = i, w.e = n, i += "", "auto" == (n += "") && (t.style[e] = n, n = An(t, e) || n, t.style[e] = i), ct(o = [i, n]), n = o[1], u = (i = o[0]).match(ri) || [], (n.match(ri) || []).length) {
                    for (; a = ri.exec(n);) l = a[0], d = n.substring(y, a.index), f ? f = (f + 1) % 5 : "rgba(" !== d.substr(-5) && "hsla(" !== d.substr(-5) || (f = 1), l !== (c = u[b++] || "") && (h = parseFloat(c) || 0, g = c.substr((h + "").length), (m = "=" === l.charAt(1) ? +(l.charAt(0) + "1") : 0) && (l = l.substr(2)), v = parseFloat(l), p = l.substr((v + "").length), y = ri.lastIndex - p.length, p || (p = p || Qt.units[e] || g, y === n.length && (n += p, w.e += p)), g !== p && (h = Ln(t, e, c, p) || 0), w._pt = {
                        _next: w._pt,
                        p: d || 1 === b ? d : ",",
                        s: h,
                        c: m ? m * v : v - h,
            ...
            function Nn(t, e) {
                if (e.tween && e.tween._time === e.tween._dur) {
                    ...
                    if ("all" === a || !0 === a) o.cssText = "", n = 1;
                        ...
                        for (r = (a = a.split(",")).length; - 1 < --r;) i = a[r], Mr[i] && (n = 1, i = "transformOrigin" === i ? Ar : Cr), Dn(s, i);
                    n && (Dn(s, Cr), u && (u.svg && s.removeAttribute("transform"), Lr(s, 1), u.uncache = 1))
                }
            }
            ...
            function Hn(t, e, i) {
                var n, r, s, o, a, u, h, f = Gn({}, i._gsap),
                    c = i.style;
            ...
            var $n, Jn, Kn, tr, ir, nr, rr = Ii.Power0,
                ...
                Ur = function(t, e) {
                    ...
                    p !== Nr && (y += "perspective(" + p + Qr), (n || r) && (y += "translate(" + n + "%, " + r + "%) "), !b && s === Nr && o === Nr && a === Nr || (y += a !== Nr || b ? "translate3d(" + s + ", " + o + ", " + a + ") " : "translate(" + s + ", " + o + Qr), u !== jr && (y += "rotate(" + u + Qr), h !== jr && (y += "rotateY(" + h + Qr), f !== jr && (y += "rotateX(" + f + Qr), c === jr && l === jr || (y += "skew(" + c + ", " + l + Qr), 1 === v && 1 === d || (y += "scale(" + v + ", " + d + Qr), m.style[Cr] = y || "translate(0, 0)"
                },
                Wr = function(t, e) {
            ...
            var Zr, Vr, qr = {
                ...
                init: function(t, e, i, n, r) {
                    var s, o, a, u, h, f, c, l, v, d, g, m, w, y, b, M = this._props,
                        x = t.style,
                        _ = i.vars.startAt;
                    for (c in Kn || In(), e)
                        ...
                        if (_ && c in _ ? (s = "function" == typeof _[c] ? _[c].call(i, n, t, r) : _[c], c in Qt.units && !G(s) && (s += Qt.units[c]), "=" === (s + "").charAt(1) && (s = Xn(t, c))) : s = Xn(t, c), u = parseFloat(s), (d = "string" === h && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) && (o = o.substr(2)), a = parseFloat(o), c in Fr && ("autoAlpha" === c && (1 === u && "hidden" === Xn(t, "visibility") && a && (u = 0), Bn(this, x, "visibility", u ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)), "scale" !== c && "transform" !== c && ~(c = Fr[c]).indexOf(",") && (c = c.split(",")[0])), g = c in Mr)
                            if (m || ((w = t._gsap).renderTransform && !e.parseTransform || Lr(t, e.parseTransform), y = !1 !== e.smoothOrigin && w.smooth, (m = this._pt = new cn(this._pt, x, Cr, 0, 1, w.renderTransform, w, 0, -1)).dep = 1), "scale" === c) this._pt = new cn(this._pt, w, "scaleY", w.scaleY, d ? d * a : a - w.scaleY), M.push("scaleY", c), c += "X";
                            else {
                        ...
                        if (g || (a || 0 === a) && (u || 0 === u) && !Sr.test(o) && c in x) a = a || 0, (l = (s + "").substr((u + "").length)) !== (v = G(o) || (c in Qt.units ? Qt.units[c] : l)) && (u = Ln(t, c, s, v)), this._pt = new cn(this._pt, g ? w : x, c, u, d ? d * a : a - u, g || "px" !== v && "zIndex" !== c || !1 === e.autoRound ? mn : bn), this._pt.u = v || 0, l !== v && (this._pt.b = s, this._pt.r = yn);
        ...
        var r = n.gsap;
        return i.GreenSockGlobals = t, h.J = r.timeline, h.l = r.ticker, h.K = r, h.K
