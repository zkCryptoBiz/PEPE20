(function(t) {
    ...
    var s = t.document,
        ...
        m = function(t, i) {
            for (var s = Object(t), h = 1; h < arguments.length; h++) {
                var n = arguments[h];
                if (null !== n && n !== o)
                    for (var r in n) null !== n[r] && Object.prototype.hasOwnProperty.call(n, r) && ("object" == typeof n[r] && (n[r].constructor === Object || Array.isArray(n[r])) ? (Array.isArray(n[r]) ? s[r] = [] : ("object" != typeof s[r] || Array.isArray(s[r])) && (s[r] = {}), s[r] = m(s[r], n[r])) : s[r] = n[r])
            }
            return s
        },
        v = function(t, i) {
        ...
        Y = function(t, i) {
            return z(t, new Event(i, {
                bubbles: !1,
                cancelable: !1
            }))
        },
        Z = function(t, i, s) {
            return z(t, new CustomEvent(i, {
                bubbles: !1,
                cancelable: !1,
                detail: s
            }))
        ...
        U = function(t, i, s, h) {
            return h = h || {}, t.addEventListener(i, s, h), t.removeEventListener.bind(t, i, s, h)
        },
        j = function(t, i, s, h) {
        ...
        Q = function(t, i) {
            if (this.ssEvent && this.ssEvent[t])
                for (var s = this.ssEvent[t], h = s.length - 1; h >= 0; h--) s[h] === i && s.splice(h, 1)
        },
        J = function() {
            return h.scrollTop
        },
            ...
            if (Math.abs(t.scrollTop - i) < 1) h && h();
                ...
                var n = t.scrollTop,
                    ...
                    a = function(i) {
                        ...
                        c < .5 ? c *= 2 * c : c = (4 - 2 * c) * c - 1, t.scrollTop = n + c * o, c < 1 ? requestAnimationFrame(a) : h && h()
                    };
                a(r)
            }
        },
        ...
        ut = navigator.userAgent.indexOf("+http://www.google.com/bot.html") > -1 ? function(t) {
            t()
        } : i.requestIdleCallback || function(t) {
            return r(t, 1)
        },
        ft = i.cancelIdleCallback || function(t) {
            a(t)
        };
    ...
    function lt(t) {
        ...
        if (i && i.sheet) {
            var h, n = i.sheet;
            for (h = n.cssRules.length - 1; h >= 0; h--) n.cssRules[h].selectorText && n.cssRules[h].selectorText.includes("div#n2-ss-") && n.deleteRule(h)
        }
    }
    nt((function() {
        n = s.body
        ...
        return t.prototype.preLoad = function(t) {
            ...
            this.onSlideDeviceChanged(this.slider.responsive.getDeviceMode()), j(this.slider.sliderElement, "SliderDevice", function(e) {
            ...
            }.bind(this)), this.preLoad(this.preLoadSlides(this.slider.getVisibleSlides(this.slider.currentSlide)))) : (this.preLoadSlides = this._preLoadSlides, this.preLoad(this.preLoadAll())), j(this.slider.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
            ...
            if (this.lazyLoadNeighbor)
                for (var s = 0, h = t[0].getPrevious(), n = t[t.length - 1].getNext(); s < this.lazyLoadNeighbor;) h && (i.push(h.preLoad()), h = h.getPrevious()), n && (i.push(n.preLoad()), n = n.getNext()), s++;
            if (this.slider.stages.resolved("Visible"))
                for (var o = 0; o < i.length; o++) this.slider.m.addPromise(i[o]);
            return i
        }, t
    })), lt("litespeed-optm-css-rules"), lt("rocket-critical-css"), c.d("SmartSliderLoad", (function() {
        ...
        return s.prototype.start = function() {
            ...
            this.slider.responsive.doResize(), requestAnimationFrame(function() {
                this.slider.initLayerAnimations(), this.slider.stages.resolve("LayerAnimations")
            }.bind(this)), this.slider.stages.done("LayerAnimations", this.stage4.bind(this))
        }, s.prototype.stage4 = function() {
            this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), c.MW.U(function() {
                F(this.slider.responsive.alignElement, "n2-ss-align-visible"), F(this.slider.sliderElement, "n2-ss-loaded"), N(this.slider.sliderElement, "n2notransition"), requestAnimationFrame((function() {
                    W(i, "scroll")
        ...
        return t.prototype.add = function(t, s, n, o) {
            var r = {
                el: t,
                mode: s,
                onVisible: n,
            ...
            this.items.push(r), this._onScroll(r, Math.max(h.clientHeight, i.innerHeight)), this.started || this.start()
            ...
            for (var t = Math.max(h.clientHeight, i.innerHeight), s = 0; s < this.items.length; s++) this._onScroll(this.items[s], t)
        }, t.prototype._onScroll = function(t, i) {
            var s = t.el.getBoundingClientRect(),
                h = s.height > .7 * i,
                n = !0;
            "partly-visible" === t.mode ? (h && (s.bottom < 0 || s.top >= s.height) || !h && (s.bottom - s.height < 0 || s.top - i + s.height >= 0)) && (n = !1) : "not-visible" === t.mode && (n = s.top - i < 0 && s.top + s.height > 0), !1 === n ? "hidden" !== t.state && ("function" == typeof t.onHide && t.onHide(), t.state = "hidden") : "visible" !== t.state && ("function" == typeof t.onVisible && t.onVisible(), t.state = "visible")
        }, new t
        ...
        t.prototype.makeReady = function(t, i) {
            ...
            var s = i.split(","),
                ...
                n = h.ssLastEvent;
            t.ssResetEvents || (t.ssResetEvents = 1, j(h, "layerAnimationPlayIn", function(t) {
                t.ssLastEvent = ""
            }.bind(this, h)));
            for (var o = s.length - 1, r = 0; r < s.length; r++) s[r] === n && (o = r);
            i = o === s.length - 1 ? s[0] : s[o + 1], h.ssLastEvent = i, Y(h, "ss" + i)
            ...
            this.isClickAllowed(e) && (c._shouldPreventClick || (e.preventDefault(), this.applyAction.apply(this, arguments)))
            ...
            if (this.isClickAllowed(e)) {
                ...
                if (t === o && (t = A(e.currentTarget, "target")), "_blank" === t) {
                    var h = i.open();
        ...
        var r = {
            focusOffsetTop: 0,
            to: function(t) {
                var n = s.querySelector("html, body, .n2_iframe_application__content");
                "smooth" === O(h, "scroll-behavior") ? n.scrollTop = t : et(n, t, i.n2ScrollSpeed || 400)
            },
            top: function() {
                r.to(0)
            },
            ...
            element: function(t) {
                "string" == typeof t && (t = s.querySelector(t)), r.to(ht(t) - r.focusOffsetTop)
            }
        };
        ...
        function t(s, h) {
            if (this.editor = null, this.elementID = s, i[s] && i[s] instanceof t)
                if (i[s].__sliderElement && !n.contains(i[s].__sliderElement));
                    ...
                    if (n.contains(i[s].sliderElement)) return void console.error("Slider [#" + s + "] embedded multiple times")
                }
            this.stages = new c.Stages, c.d("#" + s, function() {
                return this
            }.bind(this)), this.isAdmin = !!h.admin, c.SmartSliderPlugins.addSlider(this), this.id = parseInt(s.replace("n2-ss-", "")), i[s] = this, h.isDelayed !== o && h.isDelayed ? nt(function() {
                this.waitForExists(s, h)
            }.bind(this)) : this.waitForExists(s, h)
        }
        t.prototype.kill = function() {
            this.killed = !0;
            var t = this.sliderElement.closest(".n2-ss-margin");
            t ? R(t) : c.r("documentReady", function() {
                R(this.sliderElement.closest(".n2-ss-margin"))
            }.bind(this));
            var i = this.sliderElement.closest(".n2-ss-align");
            i ? R(i) : c.r("documentReady", function() {
        ...
        function f(t, s) {
            if (i.IntersectionObserver) new IntersectionObserver(function(t, i) {
                ...
                h.push(U(i, "resize", n, {
                    ...
                    capture: !0,
                    passive: !0
                })), c.SmartSliderApi.on("SliderResize", n), n()
            }
        }
        return t.prototype.onSliderExists = function(t, s, h) {
            if (this.__sliderElement = h, this.v = h.closest(".n2-section-smartslider"), this.m = this.v.querySelector("ss3-loader"), this.stages.resolve("Exists"), "TEMPLATE" === h.tagName) {
                var n = h.parentNode;
                n.removeChild(h);
                var o = A(h, "loadingType"),
                    a = h.content.children[0],
                    u = function() {
                        n.appendChild(a), L(this.v, "height"), this.waitForDimension(a, s), Z(i, "n2Rocket", {
                            sliderElement: a
                        })
                    }.bind(this);
                "afterOnLoad" === o ? c.r("windowLoad", f.bind(this, this.v, u)) : "afterDelay" === o ? r(u, A(h, "loadingDelay")) : u()
            ...
            this.stages.resolve("HasDimension"), this.killed = !1, this.isVisible = !0, this.responsive = !1, this.mainAnimationLastChangeTime = 0, this.currentSlide = null, this.currentRealSlide = null, this.staticSlides = [], this.slides = [], this.visibleRealSlides = [], this.visibleSlides = [], t.ss = this, this.sliderElement = t, this.needBackgroundWrap = !1, this.blockCarousel = !1, this.parameters = d({
                ...
                postBackgroundAnimations: !1
            }, n2const.isSamsungBrowser && (this.disabled.layerSplitTextAnimations = !0, this.disabled.postBackgroundAnimations = !0, this.parameters.postBackgroundAnimations && N(this.sliderElement, "n2-ss-feature-post-bg-loader"));
            try {
            ...
            var s;
            if (new c.UniversalEnter(this.sliderElement, function(e) {
                    e.target.closest(".n2-full-screen-widget") || (a(s), !0, F(this.sliderElement, "n2-hover"), this.widgets.setState("hover", !0), G(this.sliderElement, "universalleave", function(e) {
                        e.stopPropagation(), s = r(function() {
                            !1, N(this.sliderElement, "n2-hover"), this.widgets.setState("hover", !1)
                        }.bind(this), 1e3)
                    }.bind(this)))
                }.bind(this)), this.parameters.carousel || this.initNotCarousel(), this.initHideArrow(), this.controls = {}, this.initMainAnimationWithLayerAnimation(), n2Slow || this.isAdmin || !this.parameters.parallax.enabled || !this.parameters.parallax.mobile && (this.parameters.parallax.mobile || n2const.isMobile) || this.ready(function() {
                    this.parallax = new c.LayerParallax(this, this.parameters.parallax), this.parallax.start(this.currentSlide), j(this.sliderElement, "SlideWillChange", function(e) {
                        this.parallax.start(e.detail.targetSlide.slides[0])
                    }.bind(this))
                }.bind(this)), this.parameters.blockrightclick && j(this.sliderElement, "contextmenu", (function(e) {
                    e.preventDefault()
                })), this.initMainAnimation(), this.initResponsiveMode(), !this.killed) {
                if (j(this.sliderElement, "touchstart", function() {
                    ...
                    var h = "click";
                    this.hasTouch() && (h = "n2click"), this.sliderElement.querySelectorAll('[data-n2click="url"]').forEach((function(t) {
                        j(t, h, (function(e) {
                            n2ss.openUrl(e)
                ...
                this.load.start(), j(this.sliderElement, "keydown", (function(t) {
                    "Space" !== t.code && "Enter" !== t.code || t.target.matches('[role="button"],[tabindex]') && t.target.matches(":not(a,input,select,textarea)") && (t.preventDefault(), t.target.click(), Y(t.target, "n2Activate"))
            ...
            for (t = 0; t < this.slides.length; t++) this.slides[t].init(), 1 == +A(this.slides[t].element, "first") && (this.originalRealStarterSlide = this.slides[t]);
            this.realSlides = this.slides, this.visibleSlides = this.slides, this.initSlidesEnd()
        }, t.prototype.initSlidesEnd = function() {
            this.afterRawSlidesReady(), this.stages.resolve("RawSlides"), this.randomize(this.realSlides), this.stages.resolve("RawSlidesOrdered"), this.p()
        }, t.prototype.p = function() {
            for (var t = this.sliderElement.querySelectorAll(".n2-ss-static-slide"), i = 0; i < t.length; i++) this.staticSlides.push(new c.FrontendSliderStaticSlide(this, t[i]))
        }, t.prototype.createSlide = function(t, i) {
            return new c.FrontendSliderSlide(this, t, i)
        }, t.prototype.afterRawSlidesReady = function() {}, t.prototype.h = function(t, i) {
            ...
            return this.sliderElement.querySelector('.n2-ss-slide-background[data-public-id="' + A(t.element, "slidePublicId") + '"]')
            ...
            if (this.isAdmin) this.finalizeStarterSlideComplete(t);
                ...
                this.overrideStarterSlideIndex(s), j(this.sliderElement, "mainAnimationComplete", function(e) {
            ...
            t !== o && t.isVisible || (t = this.visibleRealSlides[0]), t !== o ? this.finalizeStarterSlideComplete2(t) : (this.hide(), G(this.sliderElement, "SliderResize", function() {
            ...
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                o.observe(this.sliderElement), this.it = [n.disconnect.bind(n), o.disconnect.bind(o), U(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            ...
            if (this.responsive.parameters.focusUser && !t && (s = !0), s) {
                var h = J(),
                    ...
                    l = "";
                "top-force" === f ? l = "top" : "bottom-force" === f ? l = "bottom" : c <= 0 && u <= 0 || c > 0 && u > 0 || (c < 0 ? l = "top" === f ? "top" : "bottom" === f ? "bottom" : -c <= u ? "top" : "bottom" : u < 0 && (l = "top" === f ? "top" : "bottom" === f || -u <= c ? "bottom" : "top"));
                var d = h;
                if ("top" === l ? d = h - n + a.top : "bottom" === l && (d = h + o + a.bottom - r), (d = Math.round(d)) !== h) return this._scrollTo(d, Math.abs(h - d))
            }
            return !0
        }, t.prototype._scrollTo = function(t, n) {
            var o = !1;
            return "smooth" === O(h, "scroll-behavior") && (C(h, "scroll-behavior", ""), o = !0), i.nextendScrollFocus = !0, new Promise((function(i) {
                et(s.scrollingElement, t, n, i)
            })).then((function() {
                o && C(h, "scroll-behavior", "smooth"), i.nextendScrollFocus = !1
            }))
            ...
            this.stages.done("StarterSlide", function() {
                t(this.currentSlide), j(this.sliderElement, "SliderResize", function() {
                    t(this.currentSlide)
                }.bind(this))
            }.bind(this)), j(this.sliderElement, "SlideWillChange", (function(e) {
                    ...
                    if (t !== this.currentSlide.index) {
                        if (this.mainAnimationLastChangeTime < n) {
                            ...
                            if ("ended" === r) {
                                ...
                                h !== o && (a = h), this._changeTo(t, i, s, h), a.changeTo(this.currentSlide, this.slides[t], i, s), this._changeCurrentSlide(t)
                            } else "initAnimation" !== r && "playing" !== r || (this.__fastChangeRemoveCallback && this.__fastChangeRemoveCallback(), this.__fastChangeRemoveCallback = U(this.sliderElement, "mainAnimationComplete", function() {
            ...
            this.setCurrentRealSlide(this.slides[t]), this.h("sliderChangeCurrentSlide")
        }, t.prototype._changeTo = function(t, i, s, h) {}, t.prototype.revertTo = function(t, i) {
            this.slides[i].unsetActive(), this.slides[t].setActive(), this._changeCurrentSlide(t), this.h("SlideWillChange", {
                targetSlide: this.slides[t]
            })
            ...
            "forced" === this.parameters.layerMode.mode && j(this.sliderElement, "preChangeToPlay", function(e) {
                var t = e.detail.currentSlide;
                e.detail.resolveHandled.handled = !0, G(t.element, "layerAnimationCompleteOut", e.detail.resolve), t.playOut()
            }.bind(this)), j(this.sliderElement, "mainAnimationStart", this.onMainAnimationStartSyncLayers.bind(this, this.parameters.layerMode)), j(this.sliderElement, "reverseModeEnabled", this.onMainAnimationStartSyncLayersReverse.bind(this, this.parameters.layerMode))
            ...
            "mainInStart" === t.inAnimation ? s.push(U(i.element, "mainAnimationStartIn", function() {
                h(), this.playSlide(i)
            }.bind(this))) : "mainInEnd" === t.inAnimation && s.push(U(i.element, "mainAnimationCompleteIn", function() {
                h(), this.playSlide(i)
            }.bind(this))), s.push(U(i.element, "mainAnimationStartInCancel", h))
            ...
            "mainInStart" === t.inAnimation ? s.push(U(i.element, "mainAnimationStartIn", function() {
                ...
                h(), this.playSlide(i)
            }.bind(this))), s.push(U(this.sliderElement, "mainAnimationComplete", h))
            ...
            this.isVisible && (F(this.responsive.alignElement, "n2-ss-slider-has-no-slide"), this.load.placeholder && F(this.load.placeholder, "n2-ss-slider-has-no-slide"), this.isVisible = !1)
        }, t.prototype.show = function() {
            this.isVisible || (F(this.responsive.alignElement, "n2-ss-slider-has-no-slide"), this.load.placeholder && N(this.load.placeholder, "n2-ss-slider-has-no-slide"), W(i, "scroll"), this.isVisible = !0)
            ...
            for (var i = 0; i < this.realSlides.length; i++) this.realSlides[i].initLayerAnimations();
            j(this.sliderElement, "SliderDeviceOrientation", this._deviceSlides.bind(this)), j(this.sliderElement, "SliderResize", this._resizeSlides.bind(this)), this.isAdmin || (this.parameters.layerMode.playFirstLayer || this.currentSlide.playSpecialEventOnlySetToZero(), this.visible(function() {
            ...
            for (var t = e.detail.device, i = 0; i < this.staticSlides.length; i++) this.staticSlides[i].setDevice(t);
            for (var s = 0; s < this.realSlides.length; s++) this.realSlides[s].setDevice(t)
        }, t.prototype._resizeSlides = function(e) {
            for (var t = e.detail.ratios, i = 0; i < this.staticSlides.length; i++) this.staticSlides[i].resize(t);
            for (var s = 0; s < this.realSlides.length; s++) this.realSlides[s].resize(t)
        }, t.prototype.getSlideBackgroundContainer = function() {}, t.prototype.getPerspective = function() {
        ...
        return t.prototype.get = function(t) {
            ...
            if ("string" == typeof t) s = this.get(t).getPromise();
                ...
                for (var h = [], n = 0; n < t.length; n++) h.push(this.get(t[n]).getPromise());
                s = Promise.all(h)
            }
            s.then(i)
        ...
        return t.prototype.register = function(t, i) {
            ...
            this.advancedElement = this.slider.sliderElement.querySelector(".n2-ss-slider-controls-advanced"), this.requiredVariables = this.advancedElement ? (A(this.advancedElement, "variables") || "").split(",") : [], j(this.slider.sliderElement, "visibleSlidesChanged", function() {
                        ...
                        for (var h = s.split(","), n = h.length - 1; n >= 0; n--) {
                            ...
                            if (2 === r.length) {
                                var a = parseInt(r[0]),
                                    c = parseInt(r[1]);
                                if (a <= c)
                                    for (var u = a; u <= c; u++) h.push(u)
                            } else h[n] = parseInt(h[n])
                        }
                        if (h.length > 0) {
                            for (n = 0; n < h.length; n++) this.excludedSlides[i + "-" + h[n]] = !0;
                            t = !0
                        }
                    }
                }
            ...
            this.requiredVariables.length && this.advancedElement && (this.flushAdvancedVariables(), j(this.slider.sliderElement, "SliderResize", this.flushAdvancedVariables.bind(this))), this.onStateChangeAll(), this.slider.stages.resolve("WidgetsReady"), this.advancedElement && this.slider.stages.done("BeforeShow", function() {
                F(this.advancedElement, "n2-ss-slider-controls-advanced--ready")
            }.bind(this))
            ...
            this.advancedElement && (A(this.advancedElement, "variables") || "").match(t) && this.flushAdvancedVariables()
        }, t
    })), c.d("SmartSliderPluginLightbox", ["SmartSliderPlugins", "litebox"], (function() {
        function t(t) {
            t.isAdmin || (this.slider = t, t.stages.done("Visible", this.onVisible.bind(this)))
        }
        t.prototype.onVisible = function() {
            if (this.slider.parameters.plugins.lightbox !== o) {
                this.parameters = d({
                    label: ""
                }, this.slider.parameters.plugins.lightbox), this.onVisibleRealSlidesChanged(), j(this.slider.sliderElement, "visibleRealSlidesChanged", this.onVisibleRealSlidesChanged.bind(this));
                var t = "click";
                ...
                for (var i = 0; i < this.slider.realSlides.length; i++)
                    if (this.slider.realSlides[i].getLightboxImage()) {
                        ...
                        p(s, "data-force-pointer", "zoom-in"), j(s, t, function(t, e) {
                            n2ss.isClickAllowed(e) && !e.target.classList.contains("smart-slider-overlay") && r(function() {
            ...
            this.lightboxes !== o && this.lightboxes.forEach((function(t) {
                R(t)
            })), this.lightboxes = [];
            for (var t = 0, i = 0; t < this.slider.visibleRealSlides.length; t++) {
                var s = this.slider.visibleRealSlides[t],
                    h = s.getLightboxImage();
                if (h) {
                    var n = f("a");
                    switch (n.href = h, n.className = "nolightbox no-lightbox", n.style.display = "none", n.slide = s, P(n, "n2Lightbox", ""), P(n, "liteboxGroup", this.slider.id), P(n, "index", i), this.parameters.label) {
                        case "name":
                            P(n, "title", s.getTitle());
                            break;
                        case "namemore":
                            P(n, "title", s.getTitle()), P(n, "description", s.getDescription())
                    }
                    s.element.appendChild(n), j(n, "click", (function(e) {
                        e.stopPropagation()
                    })), s.element.lightbox = n, this.lightboxes.push(n), i++
                }
            }
            n2LightboxSingle(this.lightboxes, {
                ...
                callbackPrev: function() {
                    ...
                    t < 0 && (t = this.lightboxes.length - 1), this.currentLightboxedImage = this.lightboxes[t];
                    var i = this.currentLightboxedImage.slide;
                    this.slider.directionalChangeTo(i.group.index)
                }.bind(this),
                callbackNext: function() {
                    var t = +A(this.currentLightboxedImage, "index") + 1;
                    t === this.lightboxes.length && (t = 0), this.currentLightboxedImage = this.lightboxes[t];
                    var i = this.currentLightboxedImage.slide;
                    this.slider.directionalChangeTo(i.group.index)
                }.bind(this)
            })
        }, t.prototype.openLightbox = function(t) {
            this.currentLightboxedImage = t.element.lightbox, W(this.currentLightboxedImage, "click")
        }, c.SmartSliderPlugins.addPlugin("lightbox", t)
    })), c.d("SmartSliderPluginParticleJS", ["SmartSliderPlugins", "particlesJS"], (function() {
        function t(t) {
            this.slider = t, t.stages.done("Parameters", function() {
        ...
        t.prototype.onBeforeShow = function() {
            ...
            if (this.pJS && (this._removeListener && this._removeListener(), this.pJS.pJS.fn.vendors.destroypJS()), t) {
                if (!t.mobile && n2const.isPhone) return;
                t.interactivity = t.interactivity || {}, t.interactivity.detect_on = this.slider.sliderElement, this.pJS = c.particlesJS(this.slider.getSlideBackgroundContainer(), t), this._removeListener = U(this.slider.sliderElement, "SliderResize", function() {
        ...
        function t(t, i) {
            this.state = "ended", this.isTouch = !1, this.isReverseAllowed = !0, this.isReverseEnabled = !1, this.reverseSlideIndex = null, this.isNoAnimation = !1, this.slider = t, this.parameters = d({
                duration: 1500,
                ease: "easeInOutQuint"
            }, i), this.parameters.duration = Math.max(.01, this.parameters.duration / 1e3), this.sliderElement = t.sliderElement, this.timeline = new c.J({
                paused: !0
            }), j(this.sliderElement, "mainAnimationStart", function(e) {
        ...
        return t.prototype.init = function() {
            ...
            this.isReverseEnabled = !0, this.reverseTimeline = new c.J({
                paused: !0
            ...
            if (this._initAnimation(t, i, s), this.state = "initAnimation", this.timeline.paused(!0), this.timeline.eventCallback("onStart", this.onChangeToStart.bind(this), [t, i, h]), this.timeline.eventCallback("onComplete", this.onChangeToComplete.bind(this), [t, i, h]), this.timeline.eventCallback("onReverseComplete", null), this.revertCB = function(s) {
                    s.eventCallback("onReverseComplete", this.onReverseChangeToComplete.bind(this), [i, t, h])
                }.bind(this), this.isTouch) t.onOutAnimationsPlayed();
            else {
                var n = {
                    handled: !1
                };
            ...
            }), G(this.sliderElement, "mainAnimationComplete", this.revertTo.bind(this, t, i))
        }, t.prototype.revertTo = function(t, i) {
            this.slider.revertTo(t, i), Y(this.slider.slides[i].element, "mainAnimationStartInCancel")
        }, t.prototype.willCleanSlideIndex = function(t) {
            G(this.sliderElement, "mainAnimationComplete", this.cleanSlideIndex.bind(this, t))
            ...
            this.slider.h("mainAnimationStart", h), t.h("mainAnimationStartOut", h), i.h("mainAnimationStartIn", h)
            ...
            this.clearTimelines(), this.disableReverseMode(), t.h("mainAnimationCompleteOut", h), i.h("mainAnimationCompleteIn", h), this.state = "ended", this.slider.updateInsideSlides([i]), s || i.focus(), this.slider.h("mainAnimationComplete", h)
        ...
        function s(t, i) {
            this.tween = null, this.lastTween = null, this.slider = t, this.mainAnimation = i, this.isFirst = !0, this.visibleAddedButNotPlayed = !1, this.parameters = d({
                data: 0,
                speed: "default",
                strength: "default"
            }, t.parameters.postBackgroundAnimations), this.slider.stages.done("StarterSlide", this.init.bind(this))
        }
        return s.prototype.init = function() {
            this.ratios = d({
                slideW: 1,
                slideH: 1
            }, this.slider.responsive.ratios), this.backgrounds = this.slider.backgrounds, this.images = this.backgrounds.getBackgroundImages();
            for (var t = 0; t < this.images.length; t++) this.images[t].onReady(this.initImage.bind(this, t, this.images[t]));
            ...
            this.isFirst = !1, this.mainAnimation.hasBackgroundAnimation() || this.mainAnimation.isTouch ? G(this.slider.sliderElement, "mainAnimationComplete", this.play.bind(this)) : this.play()
            ...
            if (!n) return !1;
            var f = m({}, n.animations[Math.floor(Math.random() * n.animations.length)]);
            f.from.transformOrigin === o && (f.from.transformOrigin = n.transformOrigin);
            ...
            for (var d = 0; d < f.strength.length; d++) {
                var v = f.strength[d];
                "scale" === v ? (f.from.scale = 1 + (f.from.scale - 1) * i[a], f.to.scale = 1 + (f.to.scale - 1) * i[a]) : (f.from[v] *= i[a], f.to[v] *= i[a])
            }
            return f.from.x !== o && (f.from.x = function(t) {
                return this.ratios.slideW * t
            }.bind(this, f.from.x)), f.from.y !== o && (f.from.y = function(t) {
                return this.ratios.slideH * t
            }.bind(this, f.from.y)), f.to.x !== o && (f.to.x = function(t) {
                return this.ratios.slideW * t
            }.bind(this, f.to.x)), f.to.y !== o && (f.to.y = function(t) {
                return this.ratios.slideH * t
            }.bind(this, f.to.y)), n2const.isFirefox && (f.from.rotationZ = .1, f.to.rotationZ = .1), c.MW.t(l, f.from), c.MW.flush(), c.K.fromTo(l, t[r], f.from, f.to)
        }, s.prototype.prepareToSwitchSlide = function(t, i) {
            t && this.images[t.index].postBGTween ? (this.mainAnimation.hasBackgroundAnimation() && this.images[t.index].postBGTween.pause(), this.lastTween = this.images[t.index].postBGTween) : this.lastTween = !1, this.images[i.index].postBGTween ? this.tween = this.images[i.index].postBGTween : this.tween = !1
        ...
        function t(t, s) {
            this.st = t, this.ht = t.sliderElement, this.nt = t.v, this.et = A(this.nt, "alias"), this.ot = d({
                id: 0,
                smoothScroll: 0,
                slideSwitch: 0,
                scroll: 1
            }, s), this.et && (this.ot.smoothScroll && C(h, "scroll-behavior", "smooth"), this.ot.slideSwitch && (this.switchOnLoad(), j(i, "hashchange", function() {
        ...
        return t.prototype.getAnchor = function() {
            ...
            if (t > 0) {
                ...
                h && h.stages.resolved("StarterSlide") ? h.stages.done("BeforeShow", function() {
        ...
        function t(t, i) {
            this.slider = t, this.state = {
                ...
                wait: 0
            }, this._listeners = [], this.wait = new c.SmartSliderControlAutoplayWait(this), this._currentCount = 1, this.autoplayToSlide = 0, this.autoplayToSlideIndex = -1, this.parameters = d({
                enabled: 0,
                start: 1,
                duration: 8e3,
                autoplayLoop: 0,
        ...
        return t.prototype.preventClickHandle = function() {
            ...
            this._listeners.push(U(t, "SlideLoading", function() {
                this.wait.add("load")
            }.bind(this))), this._listeners.push(U(t, "SlideLoaded", function(e) {
                this.wait.resolve("load")
            }.bind(this))), this._listeners.push(U(t, "BeforeCurrentSlideChange", function() {
                this.wait.resolveWeak(), this.setState("mainAnimationPlaying", 1)
            }.bind(this))), this._listeners.push(U(t, "mainAnimationStart", function() {
                this._currentCount++, this.setState("mainAnimationPlaying", 1), this.wait.resolveWeak()
            }.bind(this))), this._listeners.push(U(t, "mainAnimationComplete", function(e) {
            ...
            }.bind(this))), this._listeners.push(U(t, "autoplayPause", function(e) {
                this.setState("paused", 1)
            }.bind(this))), this._listeners.push(U(t, "autoplayResume", function(e) {
            ...
            }.bind(this))), this._listeners.push(U(t, "CurrentSlideChanged", function(e) {
            ...
            if (t || i) {
                var s = !1;
                this._listeners.push(U(this.slider.sliderElement, "touchend", (function() {
                    s = !0, r((function() {
                        s = !1
                    }), 300)
                }))), this._listeners.push(U(this.slider.sliderElement, "mouseenter", function(e) {
                    this.state.pausedSecondary ? "enter" === i && this.setState("pausedSecondary", 0) : s || "enter" !== t || this.setState("pausedSecondary", 1)
                }.bind(this))), this._listeners.push(U(this.slider.sliderElement, "mouseleave", function(e) {
            ...
            t ? (this._listeners.push(U(s, "mediaStarted", function(e) {
                this.wait.add(e.detail.id)
            }.bind(this))), this._listeners.push(U(s, "mediaEnded", function(e) {
                this.wait.resolve(e.detail.id)
            }.bind(this)))) : i && this._listeners.push(U(s, "mediaEnded", function() {
            ...
            this.setState("enabled", 0), B(this._listeners), this.universalClick && (this.universalClick.remove(), delete this.universalClick), this.slider.stages.resolve("AutoplayDestroyed")
        ...
        function t(i, h, n) {
            this.slider = i, this.responsive = this.slider.responsive, this._type = this.responsive.parameters.type, this._upscale = this.responsive.parameters.upscale, this.at = !1, this.ht = this.slider.sliderElement, this.ct = this.ht.closest(".n2-section-smartslider"), j(s, t.event, this.fullScreenChange.bind(this))
        }
        return t.isSupported = !(!s.exitFullscreen && !s.webkitExitFullscreen), t.isSupported && (t.requestFullscreen = h.requestFullscreen || h.webkitRequestFullscreen, t.exitFullscreen = s.exitFullscreen || s.webkitExitFullscreen, t.event = h.requestFullscreen ? "fullscreenchange" : h.webkitRequestFullscreen ? "webkitfullscreenchange" : null), t.prototype.switchState = function() {
            ...
            this.responsive.at = !0, this.responsive.parameters.type = "fullpage", this.ht.dataset.responsive = this.responsive.parameters.type, this.responsive.parameters.upscale = !0, this._marginLeft = this.responsive.containerElement.style.marginLeft, this._marginRight = this.responsive.containerElement.style.marginRight, x(this.responsive.containerElement, {
                marginLeft: 0,
                marginRight: 0
            }), x(this.ct, {
                width: "100%",
            ...
            this.isDocumentInFullScreenMode() ? (this.slider.h("n2FullScreen"), F(h, "n2-in-fullscreen"), F(this.slider.sliderElement, "n2-ss-slider--fullscreen"), this.at = !0, "auto" === this._type && C(this.slider.responsive.alignElement, "max-width", "none"), W(i, "resize")) : (this.responsive.at = !1, this.responsive.parameters.type = this._type, this.ht.dataset.responsive = this._type, this.responsive.parameters.upscale = this._upscale, x(this.responsive.containerElement, {
                ...
                height: "",
                "background-color": ""
            }), N(this.slider.sliderElement, "n2-ss-slider--fullscreen"), N(h, "n2-in-fullscreen"), "auto" === this._type && L(this.slider.responsive.alignElement, "max-width"), W(i, "resize"), this.at = !1, this.slider.h("n2ExitFullScreen"))
        ...
        function o(i, s, n) {
            this.slider = i, this.parameters = d({}, n), this.parseEvent = "vertical" === s ? o.prototype.parseEventVertical : o.prototype.parseEventHorizontal, t || (t = new h), t.addControl(this), j(this.slider.sliderElement, "SliderKeyDown", function(e) {
                this.onKeyDown(e.detail.e)
            }.bind(this)), i.controls.keyboard = this
        }
        return h.prototype.onMouseMove = function(e) {
            this.mouseEvent = e
            ...
            if (e.target.tagName.match(/BODY|DIV|IMG/) && !e.target.isContentEditable) {
                var t;
                if (this.mouseEvent && (t = this.findSlider(s.elementFromPoint(this.mouseEvent.clientX, this.mouseEvent.clientY)))) return void Z(t, "SliderKeyDown", {
                    e: e
                });
                if (s.activeElement !== n && (t = this.findSlider(s.activeElement))) return void Z(t, "SliderKeyDown", {
                    e: e
                });
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.ut = 2 === i ? "deltaX" : "deltaY", s.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {
                passive: !1
        ...
        return t.prototype.hasScrollableParentVertical = function(t, s) {
            ...
            e.target.closest(".n2-ss-slider") && 0 !== e[this.ut] && (this.onCurveEvent(e), this.preventScroll.local || this.preventScroll.curve || Math.abs(e[this.ut]) < this.maxDelta / 2 ? e.preventDefault() : (this.preventScroll.global && e.preventDefault(), (this.slider.sliderElement === e.target || this.slider.sliderElement.contains(e.target)) && ("deltaY" === this.ut ? e.shiftKey || this.hasScrollableParentVertical(e.deltaY < 0, e.target) || this.onMouseWheel(e) : "deltaX" === this.ut && (this.hasScrollableParentHorizontal(e.target) || this.onMouseWheel(e)))))
        }, t.prototype.onMouseWheel = function(e) {
            e[this.ut] < 0 ? this.slider.isChangeCarousel("previous") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.previous(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()) : e[this.ut] > 0 && (this.slider.isChangeCarousel("next") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.next(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()))
        }, t.prototype.startCurveWatcher = function(e) {
            !1 !== this.preventScroll.curve && a(this.preventScroll.curveTimeout), this.preventScroll.curveGlobal || (this.dynamicDelta = !1, this.lastDelta = e[this.ut], this.preventScroll.curveGlobal = !0, this.preventScroll.curveGlobalTimeout = r(function() {
            ...
            if (this.preventScroll.curveGlobal) {
                this.dynamicDelta || this.lastDelta === e[this.ut] || (this.lastDelta = e[this.ut], this.dynamicDelta = !0);
        ...
        function t(t) {
            this.slider = t, this.interactiveDrag = !0, this.preventMultipleTap = !1, this._animation = t.mainAnimation, this.swipeElement = this.slider.sliderElement.querySelector(".n2_ss__touch_element"), t.controls.touch = this, t.stages.done("StarterSlide", this.onStarterSlide.bind(this)), j(t.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
        }
        return t.prototype.onStarterSlide = function() {
            this.initTouch(), j(this.slider.sliderElement, "sliderChangeCurrentSlide", this.updatePanDirections.bind(this))
        }, t.prototype.onVisibleSlidesChanged = function() {
            this.slider.visibleSlides.length > 1 ? x(this.swipeElement, {
                cursor: "grab",
                userSelect: "none"
            }) : M(this.swipeElement, ["cursor", "userSelect"])
        }, t.prototype.initTouch = function() {
            this._animation.isNoAnimation && (this.interactiveDrag = !1), this.eventBurrito = c.EventBurrito(this.swipeElement, {
                mouse: !0,
            ...
            if (!h || "unknown" !== this.currentInteraction.action) {
                ...
                var n = this.get(s);
                if ((this.currentInteraction.hadDirection || Math.abs(n) > 10 || Math.abs(s.y) > 10) && (this.logDistance(n, s.y), this.currentInteraction.percent < 1 && this.setTouchProgress(n, s.y), "touch" === this.currentInteraction.type && t.cancelable && ("switch" !== this.currentInteraction.action && "hold" !== this.currentInteraction.action || (this.currentInteraction.hadDirection = !0))), "switch" === this.currentInteraction.action) return !0
            }
            return !1
        }, t.prototype._end = function(t, i, s, h) {
            if ("switch" === this.currentInteraction.action) {
                var n = h ? 0 : this.measureRealDirection();
                if (this.interactiveDrag) this._animation.timeline.progress() < 1 && this._animation.setTouchEnd(n, this.currentInteraction.progress, s.time), this._animation.setTouch(!1);
                else n && this.callAction(this.currentInteraction.animationStartDirection);
                N(this.swipeElement, "n2-grabbing")
            }
            this.onEnd(), delete this.currentInteraction, Math.abs(s.x) < 10 && Math.abs(s.y) < 10 ? this.onTap(t) : c._preventClick()
            ...
            if ("scroll" === this.currentInteraction.action && "pointer" === this.currentInteraction.type) {
                var t = this.currentInteraction.distanceY[0],
                    ...
                    o = function() {
                        requestAnimationFrame(function() {
                            var t, i;
                            if (!this.kineticScrollCancelled && h && (t = Date.now() - n, (i = h * Math.exp(-t / 325)) > 1 || i < -1)) return K(J() + i), void o();
            ...
            delete this.kineticScrollCancelled, s.removeEventListener("pointerdown", this.cancelKineticScroll), C(h, "scroll-behavior", "")
            ...
            var s, h = this.getPercent(t - this.currentInteraction.startDistance);
            if (this.currentInteraction.percent = h, "switch" === this.currentInteraction.action) {
            ...
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.at || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && (C(h, "scroll-behavior", "auto"), K(Math.max(0, this.currentInteraction.scrollTop - t)))))
            ...
            if ("unknown" === this.currentInteraction.action && this.slider.visibleSlides.length > 1)
                if ("ended" === this._animation.state) {
                    ...
                    if ("unknown" !== t && this.currentInteraction.state[t]) {
                        ...
                        this.currentInteraction.action = "switch", F(this.swipeElement, "n2-grabbing")
                    }
            ...
            this.preventMultipleTap || (W(e.target, "n2click"), this.preventMultipleTap = !0, r(function() {
            ...
            var s = !1;
            for (var h in t) this.state[h] !== t[h] && (this.state[h] = t[h], s = !0);
            s && i && this.eventBurrito.supportsPointerEvents && this.syncTouchAction()
        }, t
    })), c.d("SmartSliderControlTouchHorizontal", "SmartSliderControlTouch", (function() {
        "use strict";
        ...
        function t() {
            this.state = {
                left: !1,
                right: !1
            }, this.axis = "horizontal", c.SmartSliderControlTouch.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(c.SmartSliderControlTouch.prototype), t.prototype.constructor = t, t.prototype.callAction = function(t, i) {
            switch (t) {
                case "left":
            ...
            C(this.swipeElement, "touch-action", t), i.PointerEventsPolyfill && p(this.swipeElement, "touch-action", t)
        }, t
    })), c.d("SmartSliderControlTouchVertical", "SmartSliderControlTouch", (function() {
        "use strict";
        ...
        function t() {
            this.state = {
                ...
                up: "next",
                down: "previous"
            }, this.axis = "vertical", c.SmartSliderControlTouch.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(c.SmartSliderControlTouch.prototype), t.prototype.constructor = t, t.prototype.callAction = function(t, i) {
            switch (t) {
                case "up":
            ...
            this.slider.blockCarousel = !0, c.SmartSliderControlTouch.prototype._start.apply(this, arguments)
        }, t.prototype.onEnd = function(t) {
            c.SmartSliderControlTouch.prototype.onEnd.apply(this, arguments), this.slider.blockCarousel = !1
        }, t
        ...
        function t(t, i, s, h) {
            this.slide = t, this.manager = i, this.background = s, this._promise = new Promise(function(t) {
                this._resolve = t
            }.bind(this)), this.imageElements = Array.from(h)
        }
        return t.prototype.getLoadPromise = function() {
            return this._promise
            ...
            this.blur && i.push({
                ...
                blur: this.blur
            }), "blurfit" === t && (this.blurFitMode = A(this.imageElements[0], "blurfitmode"), this.globalBlurFit = A(this.imageElements[0], "globalblur"), this.editorBlur = A(this.imageElements[0], "bgblur"), i.push({
            ...
            c.K.to(c.MW.L(this.imageElements), .3, {
                opacity: 0
            })
        }, t.prototype.onSlideDeviceChanged = function() {}, t
    })), c.d("SmartSliderSlideBackgroundVideo", (function() {
        function t(t, i, s) {
            !t.slider.parameters["background.video.mobile"] && n2const.isPhone ? R(s) : n2const.isVideoAutoplayAllowed() ? (this.slide = t, this.slider = t.slider, this.background = i, this.video = s, this.isReady = !1, this.state = {
                ready: !1,
                scroll: !1,
                slide: !1,
                ended: !1
            }, this.promise = !1, i.elements.image ? this.slider.visible(this.load.bind(this)) : this.load()) : R(s)
        }
        return t.prototype.load = function() {
            if (this.video.videoWidth > 0) this.onReady();
            else {
                j(this.video, "error", this.onError.bind(this)), j(this.video, "canplay", this.onReady.bind(this)), j(this.video, "loadedmetadata", this.onReady.bind(this)), this.video.loop || j(this.video, "ended", this.onEnded.bind(this));
                var t = function() {
                    r(function() {
                        0 === this.video.networkState && this.onError()
                    }.bind(this), 100)
                }.bind(this);
                this.video.n2LoadStarted === o ? j(this.video, "loadstart", t) : t(), this.video.load(), this.safePlay()
            }
        }, t.prototype.getLoadPromise = function() {
            return !0
        }, t.prototype.onReady = function(e) {
            this.isReady || (this.isReady = !0, this.safePause(), this.slider.ready(function() {
            ...
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.setState("slide", this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]), !0)
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.setState("slide", this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]), !0)
            }.bind(this)), j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.setState("slide", this.slide.isActiveWhen(e.detail.currentSlide), !0)
            }.bind(this)), A(this.video, "resetSlideChange") && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.video.currentTime > 0 && -1 === this.slider.getVisibleSlides(this.slider.slides[e.detail.currentSlideIndex]).indexOf(this.slide) && (this.video.currentTime = 0, this.setState("ended", !1, !0))
            }.bind(this)), c.ScrollTracker.add(this.slide.element, "not-visible", function() {
                this.setState("scroll", !0, !0)
            }.bind(this), function() {
                this.setState("scroll", !1, !0)
            }.bind(this))), e && "canplay" !== e.type || this.background.fadeOut()
            ...
            this.safeCallback(function() {
                this.promise = this.video.play(), this.promise && Promise !== o && this.promise.catch(function(e) {
                    if ("NotAllowedError" === e.name) var t = function() {
            ...
            s = s || !1, this.state[t] = i, s && (this.state.ready && !this.state.ended && this.state.slide && this.state.scroll ? (this.safePlay(), Y(this.video, "n2playvideo")) : this.safePause())
        }, t
        ...
        return t.prototype.preloadOnce = function() {
            if (!this.elements) {
                this.elements = {
                    ...
                    image: !1,
                    video: !1
                }, this.currentSrc = "", this.mode = A(this.element, "mode"), this.opacity = A(this.element, "opacity");
                var t = this.element.querySelectorAll(".n2-ss-slide-background-image");
                t.length && (this.elements.image = new c[this.types.image](this.slide, this.manager, this, t), this.elements.image.preLoad());
                ...
                s && (this.elements.video = new c[this.types.video](this.slide, this, s));
                var h = this.slide.slider.parameters.backgroundParallax;
                h && h.strength > 0 && !(n2const.isPhone && !h.mobile || n2const.isTablet && !h.tablet) && this.hasBackground() && (this.slide.slider.stages.done("BeforeShow", function() {
                    this.startFixed(h)
                }.bind(this)), this.manager.hasFixed = !0), this.readyPromiseResolve(), delete this.readyPromiseResolve, delete this.readyPromise;
                var n = [];
                for (var o in this.elements) this.elements[o] && n.push(this.elements[o].getLoadPromise());
            ...
            this.slide.slider.started(function() {
                navigator.userAgent.match(/^((?!chrome|android).)*safari/i) || c.FixedBackground.addElement(this.element, t)
            }.bind(this))
        }, t
    })), c.d("FrontendComponentCommon", ["FrontendComponent"], (function() {
        function t(t, i, s, h) {
            this.wraps = {}, this.skipSelfAnimation = !1, c.FrontendComponent.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(c.FrontendComponent.prototype), t.prototype.constructor = t, t.prototype.init = function(t) {
            ...
            this.animations = A(this.layer, "animv2"), c.FrontendComponent.prototype.init.call(this, t)
        }, t.prototype.setState = function(t, i) {
            this.state[t] = i;
            ...
            this.placement.start(), c.FrontendComponent.prototype.start.call(this);
            ...
            c.FrontendComponent.prototype.onResize.apply(this, arguments), this.placement.onResize(t, i), this.animationManager && this.animationManager.onResize()
            ...
            if (!this.ft) {
                ...
                t && (this.ft = this.ft.querySelector(t), this.ft.relatedLayer = this.ft)
            }
            return this.ft
            ...
            if (!n2const.isBot) {
                if (!this.skipSelfAnimation) {
                    var h = new c.FrontendLayerAnimationManager(this, this.layer, this.getAnimatableElement(), this.slide.getPerspective());
                    h.setEventBased(this.slide.realSlide, t, i), h.hasAnimation() ? (this.animationManager = h, s.push(h)) : this.setState("InComplete", !0)
                }
                s.push.apply(s, c.FrontendComponent.prototype.createLayerAnimations.call(this, t, i))
            }
            return s
        }, t.prototype.getParallaxNodes = function() {
            var t = [];
            return this.isVisible && (A(this.layer, "ssparallax") && t.push(this.layer), t.push.apply(t, c.FrontendComponent.prototype.getParallaxNodes.call(this))), t
        ...
        function t(t, i, s, h) {
            this.device = "", this.children = [], this.slide = t, this.parent = i, this.layer = s, s.layer = this, this.isVisible = !0, this.init(h)
        }
        return t.prototype.init = function(t) {
            if (t)
                for (var i = 0; i < t.length; i++) {
                    ...
                    switch (A(s, "sstype")) {
                        case "content":
                            this.children.push(new c.FrontendComponentContent(this.slide, this, s));
                            break;
                        case "row":
                            this.children.push(new c.FrontendComponentRow(this.slide, this, s));
                            break;
                        case "col":
                            this.children.push(new c.FrontendComponentCol(this.slide, this, s));
                            break;
                        default:
                            this.children.push(new c.FrontendComponentLayer(this.slide, this, s))
                    }
                }
            ...
            return s !== o ? s : "desktopportrait" !== this.device ? A(this.layer, "desktopportrait" + t) : i !== o ? i : 0
        }, t.prototype.get = function(t) {
            ...
            if (h) {
                ...
                n && (s = s.querySelector(n)), s.addEventListener(i, function(t, e) {
                    eval(t)
                }.bind(this, h)), "click" === i && (s.style.cursor = "pointer")
            }
        }, t.prototype.getAnimatableElement = function() {
            return null
        }, t.prototype.createLayerAnimations = function(t, i) {
            for (var s = [], h = 0; h < this.children.length; h++) s.push.apply(s, this.children[h].createLayerAnimations(t, i));
            return s
        }, t.prototype.getParallaxNodes = function() {
            for (var t = [], i = 0; i < this.children.length; i++) t.push.apply(t, this.children[i].getParallaxNodes());
            return t
        }, t
    })), c.d("FrontendSlideControls", (function() {
        function t(t, i) {
            this.slider = t, this.element = i, this.element.ssSlide = this, this.status = new c.SlideStatus
        }
        return t.prototype.isCurrentlyEdited = function() {
            ...
            this.isCurrentlyEdited() || (this.status.set("INITIALIZED"), this.playOnce = !this.slider.isAdmin && this.slider.parameters.layerMode.playOnce, this.refreshTimelines(), this.isStatic() ? this.slider.visible(function() {
                this.playIn()
            }.bind(this)) : this.playOnce || j(this.element, "mainAnimationStartInCancel", this.reset.bind(this)))
        }, t.prototype.setDevice = function(t) {
            if (!this.isCurrentlyEdited())
                for (var i = 0; i < this.layerAnimations.length; i++) this.layerAnimations[i].setDevice(t)
        }, t.prototype.resize = function(t) {
            this.isCurrentlyEdited() || this.animationsRefreshRatios(t)
        }, t.prototype.animationsRefreshRatios = function(t) {
            for (var i = 0; i < this.layerAnimations.length; i++) this.layerAnimations[i].refreshRatio(t.slideW, t.slideH)
        ...
        }, t.prototype.onPlay = function() {}, t.prototype.playSpecialEventOnlySetToZero = function() {
            if (this.status.is("INITIALIZED"))
                for (var t = 0; t < this.layerAnimations.length; t++) this.layerAnimations[t].playSpecialEventOnlySetToZero()
            ...
            if (this.status.is("PLAYING")) {
                for (var t = [], i = 0; i < this.layerAnimations.length; i++) this.layerAnimations[i].beforeMainSwitch(t);
            ...
            this.playOnce ? this.status.set("ENDED") : this.status.set("INITIALIZED"), Y(this.element, "layerAnimationCompleteOut")
        ...
        var t = function() {
            if (!navigator.userAgent.match(/iphone|ipod|ipad|android/i)) return (t = function() {
                return i.innerHeight
            })();
            var s, n = Math.abs(i.orientation),
                o = {
                    w: 0,
                    h: 0
                };
            return (s = l()).style.position = "fixed", s.style.height = "100vh", s.style.width = 0, s.style.top = 0, h.appendChild(s), o.w = 90 === n ? s.offsetHeight : i.innerWidth, o.h = 90 === n ? i.innerWidth : s.offsetHeight, h.removeChild(s), s = null, (t = function() {
        ...
        return {
            ...
            listeners: [],
            start: function() {
                return !this.isStarted && (this.resize(), this.listeners.push(U(i, "load", this.resize.bind(this))), this.listeners.push(U(i, "resize", this.resize.bind(this))), this.listeners.push(U(i, "orientationchange", this.resize.bind(this))), this.listeners.push(U(s, "scroll", this.render.bind(this), {
                    capture: !0,
                    passive: !0
                })), this.isStarted = !0, !0)
            },
            ...
            addElement: function(t, i) {
                ...
                this.elements.push(s), s.animatedSMW.backfaceVisibility = "hidden", s.animatedSMW["will-change"] = "transform", this.start() || this.renderElement(s)
            },
            ...
            renderElement: function(t) {
                var i = t.parent.getBoundingClientRect(),
                    s = 0;
                if (i.top < 0 || i.height > this.windowHeight ? s = i.top / i.height : i.bottom > this.windowHeight && (s = (i.bottom - this.windowHeight) / i.height), s <= 1 && s >= -1) {
        ...
        function t(t, i) {
            this.ticking = !1, this.active = !1, this.mouseOrigin = !1, this.parallaxedNodes = [], this.parallaxedSlideNodes = null, this._scrollCallback = !1, this._listeners = [], this.firstStart = !0, this.parameters = d({
                mode: "scroll",
                origin: "slider",
                is3D: !1,
                animate: !0,
                scrollmove: "both"
            }, i), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && (this.parameters.is3D = !1, c.MW.X(t.sliderElement.querySelectorAll(".n2-ss-layers-container")).perspective = "none"), this.x = this.y = 0, this.levels = {
                1: .01,
                2: .02,
                3: .05,
                4: .1,
                ...
                9: 40,
                10: 45
            }), this.parameters.animate && (this.render = this.animateRender), this.slider = t, this.sliderElement = t.sliderElement, this.lt = this.draw.bind(this)
        }
        return t.prototype.resize = function() {
            ...
            this.active = !0, requestAnimationFrame(this.resize.bind(this)), this._listeners.push(U(this.sliderElement, "SliderResize", this.resize.bind(this)));
            var t = -1,
                s = -1;
            ...
            if ((this.mouseX || this.mouseY) && (this._listeners.push(U(this.sliderElement, "mouseenter", this.mouseEnter.bind(this))), this._listeners.push(U(this.sliderElement, "mousemove", this.mouseMove.bind(this, t, s))), this._listeners.push(U(this.sliderElement, "mouseleave", this.mouseLeave.bind(this, !1))), this.sliderElement.matches(":hover") && this.mouseEnter(!1)), this.scrollY) {
                ...
                this._scrollCallback = this.scroll.bind(this, s, h, n), this._listeners.push(U(i, "scroll", this._scrollCallback, {
                    capture: !0,
                    passive: !0
            ...
            if (null !== this.parallaxedSlideNodes && this.end(), this.firstStart) {
                if (this.parallaxedStaticSlideNodes = [], this.slider.staticSlides)
                    for (var i = 0; i < this.slider.staticSlides.length; i++) this.parallaxedStaticSlideNodes = this.parallaxedStaticSlideNodes.concat(this.slider.staticSlides[i].getParallaxNodes());
                this.firstStart = !1
            }
            if (this.parallaxedSlideNodes = t.getParallaxNodes(), this.parallaxedNodes = this.parallaxedSlideNodes.concat(this.parallaxedStaticSlideNodes), this.parallaxedNodes.length) {
                if (this.dt = c.MW.L(this.parallaxedNodes), this.parameters.is3D) {
                    var s = this.slider.getPerspective();
                    s > 0 && this.parallaxedNodes.forEach((function(t) {
            ...
            this.ticking || (c.l.add(this.lt), this.ticking = !0), this.refreshSliderDimension(), e && "enter" === this.parameters.origin ? this.mouseOrigin = {
                x: e.clientX,
                y: e.clientY
            } : this.mouseOrigin = this.dimensions
        }, t.prototype.mouseMove = function(t, i, e) {
            !1 !== this.mouseOrigin && (this.mouseX && (this.x = t * (e.clientX - this.mouseOrigin.x), this.parameters.is3D && (this.rotationY = -this.x / this.dimensions.w2)), this.mouseY && (this.y = i * (e.clientY - this.mouseOrigin.y), this.parameters.is3D && (this.rotationX = this.y / this.dimensions.h2)))
        }, t.prototype.mouseLeave = function(t) {
            this.ticking && (c.l.remove(this.lt), this.ticking = !1);
            var i = {};
            this.mouseX && (i.parallaxX = 0), this.mouseY && (i.parallaxY = 0), this.parameters.is3D && (i.parallaxRotationX = i.parallaxRotationY = 0), c.K.to(t ? c.MW.L(this.parallaxedSlideNodes) : this.dt, 2, i)
        }, t.prototype.getScrollTopRecursive = function(t, i) {
            return null === t || t.scrollTop === o ? i : (i += t.scrollTop, this.getScrollTopRecursive(t.parentNode, i))
            ...
            if (this.parallaxedNodes)
                for (var t = 0; t < this.parallaxedNodes.length; t++) {
                    ...
                    if (this.parameters.is3D) {
                        ...
                        h.parallaxRotationX = this.rotationX * n, h.parallaxRotationY = this.rotationY * n
                    }
                    h.parallaxX = Math.round(this.x * s), h.parallaxY = Math.round(this.y * s), this.render(this.dt[t], h)
                }
        ...
        return t.prototype.start = function() {}, t.prototype.onDeviceChange = function(t) {}, t.prototype.vt = function() {
        ...
        function t(t, i, s) {
            this.slides = [this], this.playCount = 0, c.FrontendSliderSlideAbstract.prototype.constructor.apply(this, arguments), this.id = A(i, "id"), this._slideFocus = i.querySelector(".n2-ss-slide--focus"), this.focusableElements = Array.from(i.querySelectorAll('a[href]:not([href=""]),link,button,input:not([type="hidden"]),select,textarea,audio[controls],video[controls],[tabindex]:not([tabindex="-1"])'));
            var h = v(i, "tabindex");
            ("0" === h || +h > 0) && this.focusableElements.push(i), this.disableFocus(), this.background = !1, t.parameters.admin ? this.minimumSlideDuration = 0 : (this.minimumSlideDuration = +A(i, "slideDuration"), this.minimumSlideDuration || (this.minimumSlideDuration = 0)), this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? (this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]'), j(t.sliderElement, "SliderDeviceOrientation", function() {
                this.slider.visibleRealSlides.push(this), this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.h("Visible")
            }.bind(this))) : (this.component = new c.FrontendComponentSectionSlide(this, t, i.querySelector('.n2-ss-layer[data-sstype="slide"]')), this.layer = this.component.layer)
        }
        t.prototype = Object.create(c.FrontendSliderSlideAbstract.prototype), t.prototype.constructor = t, t.prototype._setInside = function(t) {
        ...
        return t.prototype.focus = function() {
            ...
            for (var t = 0; t < this.focusableElements.length; t++) p(this.focusableElements[t], "tabindex", 0);
            y(this.element, "aria-hidden")
        }, t.prototype.disableFocus = function() {
            for (var t = 0; t < this.focusableElements.length; t++) p(this.focusableElements[t], "tabindex", -1);
            p(this.element, "aria-hidden", "true")
        }, t.prototype.init = function() {
            var t = this.slider.findSlideBackground(this);
            t && (this.slider.isAdmin ? this.background = new c.SmartSliderSlideBackgroundAdmin(this, t, this.slider.backgrounds) : this.background = new c.SmartSliderSlideBackground(this, t, this.slider.backgrounds)), this.element.ssSlideBackground = this.background
        }, t.prototype.onDeviceChange = function(t) {
            A(this.element, "hide" + ct(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.slider.responsive.visibleRealSlidesChanged = !0, this.h("Hidden")) : (this.slider.visibleRealSlides.push(this), !0 !== this.isVisible && (this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.h("Visible")))
        ...
        function t(t, i, s) {
            c.FrontendSlideControls.prototype.constructor.call(this, t, i), this.slides = this.slides || [], this.group = this, this.originalIndex = s, this.index = s, this.localIndex = s, this.groupIndex = 0, this.isVisible = !0, this.isInside = -1
        }
        for (var i in c.FrontendSlideControls.prototype) t.prototype[i] = c.FrontendSlideControls.prototype[i];
        ...
        function t(t, i) {
            c.FrontendSlideControls.prototype.constructor.call(this, t, i), this.slides = [this], this.isVisible = !0, this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]') : (this.component = new c.FrontendComponentSectionSlide(this, t, i.querySelector('.n2-ss-layer[data-sstype="slide"]')), this.layer = this.component.layer), this.init()
        }
        for (var i in c.FrontendSlideControls.prototype) t.prototype[i] = c.FrontendSlideControls.prototype[i];
        return t.prototype.isStatic = function() {
            ...
            A(this.element, "hide" + ct(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.h("Hidden")) : !0 !== this.isVisible && (this.isVisible = !0, this.status.is("INITIALIZED") && this.playIn(), this.h("Visible"))
        }, t
    })), c.d("FrontendPlacementAbsolute", ["FrontendPlacement"], (function() {
        var t = new class {
            constructor() {
                this.bt = new Set, this.yt = new Set, this._ = this.O.bind(this)
            }
            add(t) {
                this.bt.add(t)
            }
        ...
        function i(t) {
            this.parentLayer = !1, this.parentLayerPlacement = !1, c.FrontendPlacement.prototype.constructor.apply(this, arguments)
        }
        return i.prototype = Object.create(c.FrontendPlacement.prototype), i.prototype.constructor = i, i.prototype.start = function() {
            var i = this.layer.get("parentid");
            if (i) {
                var h = s.getElementById(i);
                h && (this.parentLayer = h.layer, this.parentLayerPlacement = this.parentLayer.placement, this.parentLayerPlacement.addLinked(this), this.onResize = function() {})
            }
            t.add(this)
            ...
            if (this.layer.parent instanceof c.FrontendComponentSectionSlide) {
                ...
                if (this.parentLayer.placement instanceof c.FrontendPlacementAbsolute) return !1
            }
            return !0
            ...
            var o = this.getWidth(h),
                ...
                a = this.getHeight(n),
                u = "number" == typeof a;
            this._sizePosition && (r && (this._sizePosition.width = o, u || (C(this.layer.layer, "width", o + "px"), this._sizePosition.height = this.layer.layer.offsetHeight)), u && (this._sizePosition.height = a)), t.width = o + (r ? "px" : ""), t.height = a + (u ? "px" : "")
            ...
            var t = this.gt,
                ...
                h = t.slideW,
                n = t.slideH;
            this.isSingleAxis() && (n = h), parseInt(this.layer.get("responsiveposition")) || (h = n = 1);
            ...
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                ...
                if (this.parentLayerPlacement instanceof c.FrontendPlacementAbsolute) {
                ...
                switch (a) {
                    case "right":
                        m = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideWidth : this.wt.width, s.xAbs = Math.round(m + o), s.xPAbs = -100;
                        break;
                    case "center":
                        m = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideWidth : this.wt.width, s.xAbs = Math.round(m / 2 + o), s.xPAbs = -50;
                        break;
                    default:
                ...
                switch (u) {
                    case "bottom":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideHeight : this.wt.height, s.yAbs = Math.round(v + r), s.yPAbs = -100;
                        break;
                    case "middle":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideHeight : this.wt.height, s.yAbs = Math.round(v / 2 + r), s.yPAbs = -50;
                        break;
                    default:
            ...
            this.isVisible() && (this.gt = i, this.St = s, t.invalidate(this), c.FrontendPlacement.prototype.onResize.apply(this, arguments))
        ...
        return t.prototype = Object.create(c.FrontendPlacement.prototype), t.prototype.constructor = t, t
        ...
        function t(t, i, s) {
            this.content = s.querySelector(".n2-ss-layer-col"), c.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.content.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.content]
        }, t
    })), c.d("FrontendComponentContent", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            this.content = s.querySelector(".n2-ss-section-main-content"), c.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.content.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.content]
        }, t
        ...
        function t(t, i, s) {
            ...
            var h = s;
            this.wraps.mask && (h = this.wraps.mask), this.item = h.querySelectorAll(":scope > *")
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return this.item
        }, t
        ...
        function t(t, i, s) {
            this.row = s.querySelector(".n2-ss-layer-row"), this.rowInner = s.querySelector(".n2-ss-layer-row-inner"), c.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.rowInner.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.row]
        }, t
        ...
        function t(t, i, s) {
            this.realSlide = t, this.slider = i, this.element = t.element, this.layer = s, this.isStatic = t.isStatic(), c.FrontendComponent.prototype.constructor.call(this, this, this, s, s.querySelectorAll(":scope > .n2-ss-layer")), j(i.sliderElement, "SliderDeviceOrientation", function(e) {
                this.onDeviceChange(e.detail.device.toLowerCase())
            }.bind(this)), j(i.sliderElement, "SliderResize", function(e) {
                this.onResize(e.detail.ratios, e.detail.responsive.resizeContext)
            }.bind(this)), this.start()
        }
        return t.prototype = Object.create(c.FrontendComponent.prototype), t.prototype.constructor = t, t.prototype.onDeviceChange = function(t) {
            c.FrontendComponent.prototype.onDeviceChange.call(this, t);
            for (var i = 0; i < this.children.length; i++) this.children[i].onDeviceChange(t);
        ...
        function t(s, h, n, o) {
            this.status = new c.AnimationStatus, this.inStatus = !1, this.loopStatus = !1, this.outStatus = !1, this.namespace = "n2-ss-animations-" + t.index++, this.hasSpecialEvent = !1, this.linear = !1, this.layer = s, this.layerElement = h, this.options = {
                repeatable: 0,
                startDelay: 0,
                endDelay: 0,
                ...
                loopStopEvent: "",
                outPlayEvent: ""
            }, this.promises = { in: new c.AnimationPromise(this, "IN"),
                loop: new c.AnimationPromise(this, "LOOP"),
                out: new c.AnimationPromise(this, "OUT"),
                reset: function() {
                    this.in.reset(), this.loop.reset(), this.out.reset()
                }
            }, this.animatableElement = n, this.perspective = o, this.perspective > 0 && (c.MW.i(this.layerElement.parentNode).perspective = this.perspective), this.plugins = new i
        }

        function i() {
            this.keys = ["basic", "reveal"], this.basic = o, this.reveal = o
        }
        return t.index = 1, t.optimizeFromTo = function(t, i, s, h, n, o) {
            t.fromTo(i, s, h, n, o)
            ...
            for (var t = 0; t < i.keys.length; t++) {
                var s = i.keys[t];
                this.options[s] && (this.plugins[s] || this.plugins.initPlugin(s, this.layerElement, this.animatableElement), this.plugins[s].collectRelatedAnimations(this.relatedAnimations, this, this.options[s]))
            }
            ...
            "loop" === t && this.loopStatus && this.loop.play(), Y(this.layerElement, t.charAt(0).toUpperCase() + t.slice(1) + "Started")
        }, t.prototype.setEventBased = function(t, i, s) {
            this.slide = t, this.horizontalRatio = i, this.verticalRatio = s;
            var h = A(this.layerElement, "animv2");
            h && ("object" != typeof h ? this.setOptions(JSON.parse(h)) : this.setOptions(h)), this.device = this.slide.slider.responsive.getDeviceMode(), this.collectRelatedAnimations(), this.options.repeatable && "" === this.options.inPlayEvent && (this.options.inPlayEvent = "layerAnimationPlayIn,OutComplete", "" === this.options.loopPlayEvent && (this.options.loopPlayEvent = "InComplete"), "" === this.options.outPlayEvent && (this.options.outPlayEvent = "LoopComplete")), "" === this.options.outPlayEvent ? "forced" === this.slide.slider.parameters.layerMode.mode ? this.options.outPlayEvent = "OutForced" : this.options.outPlayEvent = "LoopComplete" : this.options.outPlayEvent.match(/OutForced/) ? this.options.outPlayEvent = "OutForced" : this.options.outPlayEvent.match(/^(.*?,|.*? )?InstantOut(,.*?| .*?)?$/) && (this.options.outPlayEvent = "LoopComplete"), "" === this.options.inPlayEvent && (this.options.inPlayEvent = "layerAnimationPlayIn"), "" === this.options.loopPlayEvent && (this.options.loopPlayEvent = "InComplete"), this.buildTimeline() ? (this.updateRatios(i, s), this.inStatus ? (this.hasSpecialEvent || this.options.inPlayEvent.match("layerAnimationPlayIn") || (this.hasSpecialEvent = !0), this.options.inPlayEvent.match("OutComplete") ? this.promises.in.forceResolve() : this.subscribeEvent(this.options.inPlayEvent, function() {
                this.status.suspended() || (this.status.is("INITIALIZED_PLAYING") || this.status.is("IN_WAIT") ? (this.promises.in.resolveAndCheck(), delete this.targetStage) : (this.status.isLoop() || this.status.isOut() || this.targetStage !== o && "in" !== this.targetStage) && (this.status.isIn() ? delete this.targetStage : this.targetStage = "in"))
            }.bind(this))) : (this.promises.in.forceResolve(), r(function() {
            ...
            }.bind(this))), "" !== this.options.loopPauseEvent && this.subscribeEvent(this.options.loopPauseEvent, this.loop.pause.bind(this.loop)), "" !== this.options.loopStopEvent && this.subscribeEvent(this.options.loopStopEvent, this.loop.requestEnd.bind(this.loop, !1))) : (this.promises.loop.forceResolve(), this.subscribeEvent("InComplete", this.loopComplete.bind(this))), this.outStatus ? this.options.outPlayEvent.match("LoopComplete") ? this.promises.out.forceResolve() : "OutForced" === this.options.outPlayEvent || (this.hasSpecialEvent = !0, this.subscribeEvent(this.options.outPlayEvent, function() {
                this.status.suspended() || (this.status.is("OUT_WAIT") ? (this.promises.out.resolveAndCheck(), delete this.targetStage) : this.status.is("LOOP_WAIT") ? (this.promises.loop.resolve(), this.promises.out.resolve(), this.status.set("OUT_WAIT"), this.timeline.seek("OUT").play()) : this.status.is("LOOP_PLAYING") || this.status.is("LOOP_PAUSED") ? (this.promises.out.resolve(), this.loop.requestEnd(!0)) : (this.status.isIn() || this.status.isLoop() || this.targetStage !== o && "out" !== this.targetStage) && (this.status.isOut() ? delete this.targetStage : this.targetStage = "out"))
            }.bind(this))) : this.promises.out.forceResolve(), this.status.set("INITIALIZED")) : this.status.set("DISABLED")
            ...
            this.hasSpecialEvent || ("OutForced" === this.options.outPlayEvent ? this.outStatus ? (this.status.set("LOOP_WAIT"), this.timeline.seek("ZERO", !0)) : (this.status.set("OUT_ENDED"), this.timeline.progress(1, !0)) : (this.status.set("DISABLED"), this.timeline.progress(1, !0)))
        }, t.prototype.playSpecialEventOnly = function() {
            this.hasSpecialEvent && this.play()
        }, t.prototype.setOptions = function(t) {
            this.options = d(this.options, t)
        }, t.prototype.buildTimeline = function() {
            if (!this.relatedAnimations.in.length && !this.relatedAnimations.loop.length && !this.relatedAnimations.out.length) return !1;
            var t;
            this.timeline = new c.J({
                paused: !0
            });
            var i = this.options.repeatable ? this.options.startDelay : 0;
            this.timeline.addLabel("IN", i), this.linear ? this.timeline.set({}, {}, i) : (this.timeline.addPause("+=" + (.001 + i), this.promises.in.wait.bind(this.promises.in)), this.promises.in.addPauseTween(this.timeline.recent()));
            var s = new c.J;
            for (t = 0; t < this.relatedAnimations.in.length; t++) this.relatedAnimations.in[t].extendTimeline(s);
            s.totalDuration() ? (this.linear || s.eventCallback("onComplete", this.inComplete.bind(this)), this.inStatus = !0, this.timeline.add(s)) : (s.kill(), this.inStatus = !1), this.timeline.addLabel("ZERO", "+=0.001"), this.loop = new c.AnimationsControllerLoop(this, this.layerElement), this.loopStatus = this.loop.buildTimeline(this.timeline);
            var h = new c.J;
            for (t = 0; t < this.relatedAnimations.out.length; t++) this.relatedAnimations.out[t].extendTimeline(h);
            var n = this.options.repeatable ? this.options.endDelay : 0;
            return h.totalDuration() ? (this.linear ? h.set({}, {}, "+=" + n) : (this.timeline.addLabel("OUT", "+=0.001"), this.timeline.addPause("+=0.002", this.promises.out.wait.bind(this.promises.out)), this.promises.out.addPauseTween(this.timeline.recent()), h.set({}, {}, "+=" + n), h.eventCallback("onComplete", this.outComplete.bind(this))), this.outStatus = !0, this.timeline.add(h)) : (h.kill(), this.outStatus = !1, this.timeline.addLabel("OUT", "+=0.001"), this.timeline.set({}, {
                onComplete: this.outComplete.bind(this)
            }, "+=" + n)), this.hasAnimation()
        }, t.prototype.setDevice = function(t) {
            if (this.device = t, this.relatedAnimations.setDevice.length > 0)
                for (var i = 0; i < this.relatedAnimations.setDevice.length; i++) this.relatedAnimations.setDevice[i].setDevice(t)
        }, t.prototype.updateRatios = function(t, i) {
            if (this.horizontalRatio = t, this.verticalRatio = i, this.relatedAnimations.updateRatios.length > 0)
                for (var s = 0; s < this.relatedAnimations.updateRatios.length; s++) this.relatedAnimations.updateRatios[s].updateRatios(t, i)
        }, t.prototype.refreshRatio = function(t, i) {
            if (this.updateRatios(t, i), this.relatedAnimations.needInvalidate) {
                var s = this.timeline.time();
                this.timeline.invalidate(), this.timeline.progress(1, !0), this.timeline.time(s, !0)
            }
        }, t.prototype.setLinear = function(t, i, s, h) {
            return this.linear = !0, this.horizontalRatio = s, this.verticalRatio = h, this.setOptions(t.animations.getData()), this.device = i, this.collectRelatedAnimations(), this.buildTimeline(), this.updateRatios(s, h), !!this.relatedAnimations.other.length || this.hasAnimation()
        }, t.prototype.resetToEditor = function() {
            this.plugins.resetToEditor(), Y(this.layerElement, "AnimationSetZero")
        }, t.prototype.inComplete = function() {
            this.status.set("IN_ENDED"), this.layer.setState("InComplete", !0), this.outStatus && this.targetStage !== o && (this.promises.loop.resolve(), this.promises.out.resolve(), this.status.set("OUT_WAIT"), this.timeline.seek("OUT").play()), Y(this.layerElement, "InComplete"), r(function() {
                Y(this.layerElement, "layerAnimationPlayLoop")
            }.bind(this), 1)
        }, t.prototype.loopComplete = function() {
            1 !== this.options.loopRepeatSelfOnly || this.status.is("LOOP_ENDING_FORCED") ? (this.status.set("LOOP_ENDED"), this.targetStage !== o && (this.promises[this.targetStage].resolve(), delete this.targetStage), Y(this.layerElement, "LoopComplete")) : (this.promises.loop.reset(), this.loop.resetForReplay(), this.status.set("IN_ENDED"), this.timeline.seek("ZERO"))
        }, t.prototype.outComplete = function() {
            this.options.repeatable && this.hasAnimation() ? this.status.set("INITIALIZED") : this.status.set("OUT_ENDED"), Y(this.layerElement, "OutComplete"), this.status.is("INITIALIZED") && this.repeat()
        }, t.prototype.repeat = function() {
            this.loopStatus && this.loop.resetForReplay(), this.promises.reset(), this.targetStage !== o && (this.promises[this.targetStage].resolve(), delete this.targetStage), this.timeline.seek("IN"), this.timeline.timeScale(1)
        }, t.prototype.beforeMainSwitch = function(t) {
            this.status.is("DISABLED") || this.status.is("INITIALIZED") || this.status.is("INITIALIZED_PLAYING") || this.status.is("OUT_ENDED") ? this.status.set("DISABLED") : this.hasSpecialEvent ? Y(this.layerElement, "OutForced") : t.push(new Promise(function(t) {
                G(this.layerElement, "OutComplete", function() {
                    this.status.set("DISABLED"), t()
                }.bind(this)), this.forcePlayOut()
            }.bind(this)))
        }, t.prototype.forcePlayOut = function() {
            this.status.isIn() ? G(this.layerElement, "InComplete", function() {
            ...
            this.loop && this.loop.reset(), this.layer.setState("InComplete", !1), this.promises.reset(), this.status.suspended() && this.status.suspended(!1), this.status.set("INITIALIZED"), this.timeline.progress(0, !0).progress(1, !0).pause(0)
        }, t.prototype.suspend = function() {
                ...
                if (s[h].length) {
                    ...
                    switch (n[0]) {
                        ...
                        case "LayerMouseLeave":
                            o.match(/^Layer/) && (o = o.replace(/^Layer/, "").toLowerCase()), j(this.layerElement, o, i);
                            break;
                        ...
                        case "SlideClick":
                            o.match(/^Slide/) && (o = o.replace(/^Slide/, "").toLowerCase()), j(this.slide.element, o, i);
                            break;
                        case "SliderMouseEnter":
                        case "SliderMouseLeave":
                        case "SliderClick":
                            o.match(/^Slider/) && (o = o.replace(/^Slider/, "").toLowerCase()), j(this.slide.slider.sliderElement, o, function(e) {
                        ...
                        default:
                            ...
                            j(this.slide.element, "ss" + o, function(t) {
                                t.do && a(t.do), t.do = r((function() {
                                    t.killed || i(), t.killed = !1
                                }), 50)
                            }.bind(this, c)), j(this.slide.element, "cancel" + o, function(t) {
                                t.killed = !0, t.cancel && a(t.cancel), t.cancel = r((function() {
                                    t.killed = !1
                                }), 70)
                            }.bind(this, c))
                    }
        ...
        }, i.keys = ["basic", "reveal"], i.prototype.initPlugin = function(t, i, s) {
            switch (t) {
                case "basic":
        ...
        function t(t, i) {
            this.manager = t, this.status = t.status, this.stack = i, this._done = !1, this._resolved = !1, this._forced = !1, this.pauseTween = null, this.position = null
        }
        return t.prototype.addPauseTween = function(t) {
            ...
            this.resolve(), this._done && !this.status.suspended() && this.status.is(this.stack + "_WAIT") && (this.status.set(this.stack + "_PLAYING"), this.manager.onStageReached(this.stack), this.manager.timeline.paused() && this.manager.timeline.play())
        }, t
    })), c.d("AnimationsRelated", (function() {
        function t(t, i) {
            this._context = t, this._extendName = i
        }
        return t.prototype.extendTimeline = function(t, i, s) {
        ...
        function t(t, i) {
            this.hasAnimation = !1, this.layerElement = t, this.animatableElement = i, this.It = c.MW.i(i), this.It.n2AutoAlpha = 1
        }
        return t.prototype.onResize = function() {}, t.prototype.resetToEditor = function() {}, t
    })), c.d("FrontendLayerAnimationsBasic", "FrontendLayerAnimationsAbstract", (function() {
        var t = {
            opacity: 1,
            x: 0,
            y: 0,
        ...
        function s(i, s) {
            this.device = "desktopPortrait", c.FrontendLayerAnimationsAbstract.prototype.constructor.call(this, i, s), this.isAbsolute = "absolute" === A(i, "pm"), this.At = !1, this.startValues = d({}, t), this.hadImmediateRender = !1, this.horizontalRatio = this.verticalRatio = 1, this._requireUpdateRatios = !1
        }
        s.prototype = Object.create(c.FrontendLayerAnimationsAbstract.prototype), s.prototype.constructor = s, s.prototype.updateRatios = function(t, i) {
            this.horizontalRatio = t, this.verticalRatio = i
        }, s.prototype.optimizeFromTo = function(t, i, s, h, n, o) {
            this.hadImmediateRender ? n.immediateRender = !1 : this.hadImmediateRender = !0, c.FrontendLayerAnimationManager.optimizeFromTo(t, i, s, h, n, o)
        }, s.prototype.resetToEditor = function() {
            this.hasAnimation && this.setZero()
        }, s.prototype.setStartValues = function(t) {
            d(this.startValues, t), delete this.startValues.duration, delete this.startValues.delay, delete this.startValues.ease
        }, s.prototype.setZero = function() {
            this.hasAnimation && this.It.setValues(d({}, t))
        }, s.prototype.collectRelatedAnimations = function(i, s, h) {
            if (this.device = s.device, this.animationManager = s, this.hasAnimation = !0, this.currentZero = Object.assign({}, t), this.options = { in: d({
                        specialZero: 0,
                ...
                }, this.optimizeKeyFrames(), this.At && i.other.push(this), this.options.in.keyFrames.length && i.in.push(new c.AnimationsRelated(this, "extendTimelineIn")), this.options.loop.keyFrames.length) {
                var n = new c.AnimationsLayerLoop(this, s, this.layerElement, this.It, this.options.loop);
                i.loop.push(n)
            }
            this.options.out.keyFrames.length && i.out.push(new c.AnimationsRelated(this, "extendTimelineOut")), i.setDevice.push(this)
            ...
            var t, s, h = this.options.in.keyFrames,
                n = this.options.loop.keyFrames,
                o = this.options.out.keyFrames;
            for (this.usedProperties = {
                    opacity: !1,
                    x: !1,
                    y: !1,
                    z: !1,
            ...
            for (s = 0; s < n.length; s++) t = n[s] = this._fillKeyFrame(n[s]), this.prepareDeviceSpecific(t, 1);
            for (s = 0; s < o.length; s++) t = o[s] = this._fillKeyFrame(o[s]), this.prepareDeviceSpecific(t, 1);
            for (this._cleanKeyFrame(this.currentZero), s = 0; s < h.length; s++) h[s] = this._cleanKeyFrame(h[s]);
        ...
        s.prototype._fillKeyFrame = function(t) {
            for (var i in h) t[i] !== o && t[i] != h[i] && (this.usedProperties[i] = !0);
            return d({
                duration: .8,
                delay: 0,
                ease: "easeOutCubic",
            ...
            for (var i in delete t.name, this.usedProperties) this.usedProperties[i] || delete t[i];
            return t
        };
        var n = ["desktopLandscape", "desktopPortrait", "tabletLandscape", "tabletPortrait", "mobileLandscape", "mobilePortrait"];
        return s.prototype.prepareDeviceSpecific = function(t, i) {
            this.prepareDeviceSpecificProp("x", t, i), this.prepareDeviceSpecificProp("y", t, i), delete t.desktopLandscape, delete t.tabletLandscape, delete t.tabletPortrait, delete t.mobileLandscape, delete t.mobilePortrait
        }, s.prototype.prepareDeviceSpecificProp = function(t, i, s) {
            var h, r = {
                    desktopPortrait: i[t] * s
                },
                a = !1;
            for (h = 0; h < n.length; h++) i[n[h]] && i[n[h]][t] !== o && (r[n[h]] = i[n[h]][t] * s, a = !0);
            this.isAbsolute ? (this.requireUpdateRatios(), a ? (this.animationManager.needInvalidate(), i[t] = function(t) {
                return t[this.device] === o ? t.desktopPortrait * this.horizontalRatio : t[this.device] * this.horizontalRatio
            }.bind(this, r)) : 0 === r.desktopPortrait ? i[t] = 0 : i[t] = function(t) {
                return t * this.horizontalRatio
            }.bind(this, r.desktopPortrait)) : a ? (this.animationManager.needInvalidate(), i[t] = function(t) {
                return t[this.device] === o ? t.desktopPortrait : t[this.device]
            }.bind(this, r)) : i[t] = r.desktopPortrait
        }, s.prototype.extendTimelineIn = function(t) {
            this.It.transformOrigin = i(this.options.in.transformOrigin), this.buildTimelineIn(t, this.options.in.keyFrames)
            ...
            if ((i = m([], i)).length > 0) {
                ...
                if (h.length > 0)
                    for (var n = 0; n < h.length; n++) this.optimizeFromTo(t, this.It, h[n].duration, h[n].from, h[n].to, s), s += h[n].duration + h[n].to.delay;
            ...
            delete s.transformOrigin, i.push({
                to: s
            });
            for (var h = 0; h < t.length; h++) {
                var n = m({}, t[h]),
                ...
                delete r.delay, delete r.ease, i.push({
                    duration: o,
                    from: r,
                    to: n
                })
    ...
    })), c.d("FrontendLayerAnimationsReveal", "FrontendLayerAnimationsAbstract", (function() {
        var t = {
            from: "top",
        ...
        function i(t, i) {
            c.FrontendLayerAnimationsAbstract.prototype.constructor.call(this, t, i)
        }
        return i.prototype = Object.create(c.FrontendLayerAnimationsAbstract.prototype), i.prototype.constructor = i, i.prototype.resetToEditor = function() {
            this.hasAnimation && (this.in || this.out) && (this._destroyGroup("in"), this._destroyGroup("out"), c.MW.Y(c.MW.i(this.revealedElement), ["transform", "opacity", "n2AutoAlpha"]))
        }, i.prototype.setZero = function() {
            this.hasAnimation && (this.in || this.out) && (this.in && (this.in.clipSMW.visibility = "hidden"), this.out && (this.out.clipSMW.visibility = "hidden"), c.MW.Y(c.MW.i(this.revealedElement), ["transform", "opacity", "n2AutoAlpha"]))
        }, i.prototype.collectRelatedAnimations = function(t, i, s) {
            this.animationManager = i, this.in = !1, this.out = !1, s.in === o && s.out === o || (this.hasAnimation = !0, this.revealedElement = this.animatableElement.querySelector(".n2-ss-layer-content,.n2-ss-layer-row,.n2-ss-item,.n2-ss-item-content"), this.revealedElement || (this.revealedElement = l()), s.in !== o && (this.in = this._initGroup("in", s), t.in.push(new c.AnimationsRelated(this, "extendTimelineIn"))), s.out !== o && (this.out = this._initGroup("out", s), t.out.push(new c.AnimationsRelated(this, "extendTimelineOut"))))
            ...
            return n.revealedElementSMW.n2AutoAlpha = 1, this.animatableElement.appendChild(h), n
            ...
            this.in && Y(this.in.clip, "RevealInternalResize"), this.out && Y(this.out.clip, "RevealInternalResize")
        }, i
        ...
        var t = function(t, i, s) {
                ...
                switch (t) {
                    case "curtains-horizontal":
                        return h = l(), x(h, {
                            width: "50%",
                            background: "#" + s
                        }), n = h.cloneNode(), C(n, "left", "50%"), i.appendChild(h), i.appendChild(n), [h, n];
                    case "curtains-vertical":
                        return h = l(), x(h, {
                            height: "50%",
                            background: "#" + s
                        }), n = h.cloneNode(), C(n, "top", "50%"), i.appendChild(h), i.appendChild(n), [h, n];
                    case "curtains-diagonal-1":
                        ...
                        return [ot("polygon", {
                            points: "0,0 33,0 0,33",
                            fill: "#" + s
                        }, o), ot("polygon", {
                            points: "32,32 32,-1 -1,32",
                            fill: "#" + s
                        }, o)];
                    case "curtains-diagonal-2":
                        ...
                        return [ot("polygon", {
                            points: "0,32 33,32 0,-1",
                            fill: "#" + s
                        }, o), ot("polygon", {
                            points: "32,0 32,33 -1,0",
                            fill: "#" + s
                        }, o)];
                    case "circle-top":
                    case "circle-right":
                    ...
                    case "circle-left":
                        ...
                        var r = function(t, i, s) {
                            ...
                            switch (i) {
                                case "circle-top":
                                case "circle-bottom":
                                    h = 2 * Math.ceil(Math.sqrt(s.width * s.width / 4 + s.height * s.height));
                                    break;
                                case "circle-right":
                                case "circle-left":
                                    h = 2 * Math.ceil(Math.sqrt(s.width * s.width + s.height * s.height / 4))
                            }
                            x(t, {
                                "margin-top": -h / 2 + "px",
                                "margin-left": -h / 2 + "px",
                        ...
                        switch (r(i.getBoundingClientRect()), j(i, "RevealInternalResize", function(t, i) {
            ...
            i = function(t, i, s, n, r, a) {
                var c = h(r, a),
                    u = t.totalDuration();
                c.length === o && (c = [c]);
                for (var f = 0; f < c.length; f++) c[f].a.transformOrigin && (t.set(i[f], {
                    transformOrigin: c[f].a.transformOrigin
                }, u), delete c[f].a.transformOrigin), c[f].b.ease = n, t.fromTo(i[f], s, c[f].a, c[f].b, u)
            },
            s = function(t, i, s, n, r, a, c) {
                var u = h(a, c);
                u.length === o && (u = [u]);
                for (var f = 0; f < u.length; f++) u[f].a.transformOrigin && (t.set(i[f], {
                    transformOrigin: u[f].a.transformOrigin
                }, n), delete u[f].a.transformOrigin), u[f].a.ease = r, t.fromTo(i[f], s, u[f].b, u[f].a, n)
            },
            h = function(t, i) {
                var s, h, n;
                switch (t) {
                    ...
                    case "skew-top":
                        return s = i.getBoundingClientRect(), h = 20, n = Math.cos((90 - h) * Math.PI / 180) * s.width, {
                            a: {
                                y: -1 * (s.height + n),
                                skewY: -h
                            },
                    ...
                    case "skew-right":
                        return s = i.getBoundingClientRect(), h = 20, n = Math.cos((90 - h) * Math.PI / 180) * s.height, {
                            a: {
                                x: s.width + n,
                                skewX: -h
                            },
        ...
        return { in: function(h, r) {
                ...
                c.MW.t(l, {
                    visibility: "hidden"
                }), a.set({}, {}, r.options.delay), "no" !== r.options.from ? (c.MW.t(d, {
                    visibility: "hidden"
                }), a.set(l, {
                    visibility: "visible"
                }), i(a, l, f, r.options.fromease, r.options.from, r.clip), a.set(l, {
                    visibility: "hidden"
                }), a.set(d, {
                    visibility: "visible"
                ...
                v ? (v.from.opacity === o && a.set(r.revealedElementSMW, {
                    opacity: 1
                }), v.to.ease = "easeOutCubic", a.fromTo(r.revealedElementSMW, f, v.from, v.to)) : a.set(r.revealedElementSMW, {
                    opacity: 1
                }), s(a, d, f, m, r.options.toease, r.options.to, r.clip), a.set(d, {
                    visibility: "visible"
                }), a.set(r.clipSMW, {
                    visibility: "hidden"
                })
            ...
            out: function(h, r) {
                ...
                v ? (v.from.opacity === o && a.set(r.revealedElementSMW, {
                    opacity: 0
                }), v.to.ease = "easeOutCubic", a.fromTo(r.revealedElementSMW, f, v.from, v.to, m - f)) : a.set(r.revealedElementSMW, {
                    opacity: 0
                }), m = a.totalDuration(), a.set(d, {
                    visibility: "visible"
                }, m), s(a, d, f, m, r.options.toease, r.options.to, r.clip), a.set(d, {
                    visibility: "hidden"
                }), a.set(r.clipSMW, {
                    visibility: "hidden"
                })
    ...
    })), c.d("AnimationsControllerLoop", "FrontendLayerAnimationManager", (function() {
        function t(t, i) {
            this.animationManager = t, this.status = this.animationManager.status, this.layerElement = i
        }
        return t.prototype.reset = function() {
            ...
            if (!this.status.suspended() && (this.status.is("LOOP_PLAYING") || this.status.is("LOOP_PAUSED"))) {
                for (var i = 0; i < this.animations.length; i++) this.animations[i].requestEnd();
            ...
            this.animations = [];
            for (var i = 0; i < this.animationManager.relatedAnimations.loop.length; i++) this.animationManager.relatedAnimations.loop[i].setController(this, i), this.animations.push(this.animationManager.relatedAnimations.loop[i]);
            if (this.animations.length > 0) {
                ...
                for (i = 1; i < this.animations.length; i++) this.animations[i].buildTimeline(!!this.animationManager.linear && t, this.animationManager.linear ? s : 0)
            }
            return this.animations.length
        }, t
    })), c.d("AnimationsLayerLoop", ["AnimationsLoopAbstract"], (function() {
        function t(t, i, s, h, n) {
            this.layerAnimations = t, this.animationManager = i, this.layerElement = s, this.It = h, this.animationData = n.keyFrames, this.transformOrigin = n.transformOrigin.split("|*|").join("% ") + "px", this.repeatCount = n.repeatCount, this.repeatStartDelay = Math.max(0, n.repeatStartDelay), this.single = !1, c.AnimationsLoopAbstract.prototype.constructor.call(this, parseInt(this.repeatCount))
        }
        return t.prototype = Object.create(c.AnimationsLoopAbstract.prototype), t.prototype.constructor = t, t.prototype.playLoopAgain = function() {
            c.AnimationsLoopAbstract.prototype.playLoopAgain.call(this), Y(this.layerElement, "LoopRoundComplete")
        }, t.prototype.buildTimeline = function(t, i) {
            var s = this.animationManager.linear ? "linear" : "event";
            this.timeline = t || new c.J({
                paused: !0
            }), i += .001, this.timeline.set(this.It, {
                transformOrigin: this.transformOrigin,
                immediateRender: !1
            }, i), this.repeatStartDelay > 0 && (i += this.repeatStartDelay, this.timeline.set({}, {}, i)), this.buildTimelineLoop(i, s, m([], this.animationData)), this.animationManager.linear || this.timeline.set({}, {
                onComplete: this.onComplete.bind(this)
            })
        }, t.prototype.buildTimelineLoop = function(t, i, s) {
            var h, n = this._buildAnimationChainLoop(s);
            if (this.zero = m({
                    ease: n[0].to.ease
                }, n[0]), !this.single) {
                var o = this.zero.duration / 2;
                c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, o, d({}, this.layerAnimations.currentZero), d({
                    immediateRender: !1,
                    ease: this.zero.ease
                }, this.zero.from), t), t += o
            }
            if ("linear" === i) {
                var r = this.repeatCount;
                r < 1 && (r = 1);
                for (var a = 0; a < r; a++)
                    for (h = 0; h < n.length; h++) c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, n[h].duration, d({}, n[h].from), d({
                        immediateRender: !1
                    }, n[h].to), t), t += n[h].duration + (n[h].to.delay ? n[h].to.delay : 0)
            } else if ("event" === i) {
                for (this.timeline.addLabel("LOOP", t), h = 0; h < n.length; h++) n[h].to.immediateRender = !1, c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, n[h].duration, n[h].from, n[h].to, t), t += n[h].duration + (n[h].to.delay ? n[h].to.delay : 0);
                this.timeline.set({}, {
                    onComplete: this.repeat.bind(this)
                }, t)
            }
            this.single || c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, this.zero.duration / 2, d({}, this.zero.from), d({
                immediateRender: !1,
                ease: this.zero.ease
            ...
            if (1 === t.length) {
                this.single = !0;
                var s = m({}, t[0]);
                (i = d({}, this.layerAnimations.currentZero)).duration = s.duration, i.ease = s.ease, 360 !== Math.abs(s.rotationX) && 360 !== Math.abs(s.rotationY) && 360 !== Math.abs(s.rotationZ) || 1 != s.opacity && s.opacity !== o || 0 != s.x && s.x !== o || 0 != s.y && s.y !== o || 0 != s.z && s.z !== o || 1 != s.scaleX && s.scaleX !== o || 1 != s.scaleY && s.scaleY !== o || 0 != s.skewX && s.skewX !== o || 0 != s.n2blur && s.n2blur !== o ? t.push(i) : (360 == +s.rotationX ? s.rotationX = "+=360" : -360 == +s.rotationX && (s.rotationX = "-=360"), 360 == +s.rotationY ? s.rotationY = "+=360" : -360 == +s.rotationY && (s.rotationY = "-=360"), 360 == +s.rotationZ ? s.rotationZ = "+=360" : -360 == +s.rotationZ && (s.rotationZ = "-=360"))
            }
            var h = 0,
                n = [{
            ...
            for (h++; h < t.length; h++) {
                ...
                delete a.delay, delete a.ease, n.push({
                    duration: r,
                    from: a,
                    to: i
                })
            }
            return this.single || (n.push({
                duration: n[0].duration,
                from: d({}, n[n.length - 1].to),
                to: d({}, n[0].to)
            }), n.shift(), delete n[0].from.duration), n
        }, t
    })), c.d("AnimationsLoopTimeline", ["AnimationsLoopAbstract"], (function() {
        c.AnimationsLoopAbstract.status;

        function t(t, i) {
            this.manager = t, c.AnimationsLoopAbstract.prototype.constructor.call(this, i)
        }
        return t.prototype = Object.create(c.AnimationsLoopAbstract.prototype), t.prototype.constructor = t, t.prototype.buildTimeline = function(t, i) {
            this.timeline = t || new c.J({
                paused: !0
            }), this.controller.animationManager.linear ? this.repeatCount = 0 : this.timeline.addLabel("LOOP", i);
            var s = this.manager.getLoopTimeline();
            this.timeline.add(s.paused(0), i), this.controller.animationManager.linear || s.eventCallback("onComplete", function() {
        ...
        return t.prototype.setController = function(t, i) {
        ...
        }, t.prototype.buildTimeline = function(t, i) {}, t.prototype.refresh = function() {}, t.prototype.reset = function() {
    ...
    })), customElements.define("ss3-fullpage", class extends HTMLElement {
        connectedCallback() {
            "100vh" !== this.dataset.basedOn && (this.Pt = i.n2Height || i.innerHeight, x(this, {
                "--target-height": this.Pt + "px",
                opacity: 1
            }), j(i, "resize", this.onResize.bind(this)))
        }
        onResize() {
            this.updateHeight(), requestAnimationFrame(this.updateHeight.bind(this))
        }
        updateHeight() {
            var t = i.n2Height || i.innerHeight;
            Math.abs(this.Pt - t) > (this.dataset.threshold || 0) && (C(this, "--target-height", t + "px"), this.Pt = t)
        }
        ...
        function f(t, s) {
            for (var h in this.state = {
                    StarterSlide: !1
                }, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.at = !1, this.visibleRealSlidesChanged = !0, this.kt = -1, this.Ot = -1, this.Ct = -1, this.xt = -1, this.filters = {
                    SliderWidth: [],
                    SliderHeight: [],
                    SlideHeight: [],
                    SliderVerticalCSS: []
                ...
                }, s), this.mediaQueries = {}, this.parameters.mediaQueries) this.parameters.mediaQueries[h] && (this.mediaQueries[h] = i.matchMedia(this.parameters.mediaQueries[h].join(",")));
            this.parameters.hideOn = i.ssOverrideHideOn || this.parameters.hideOn, this.doThrottledResize = NextendThrottle(this.doResize.bind(this), 50), this.slider = t, this.sliderElement = t.sliderElement, this.Lt = "1" === A(this.sliderElement, "ssLegacyFontScale"), this.addFilter("SliderWidth", this.filterSliderWidthHorizontalSpacing.bind(this)), this.slider.isAdmin || "fullpage" !== this.parameters.type || this.slider.stages.done("WidgetsReady", function() {
                var t = this.getVerticalOffsetHeight();
                this.Mt !== t && this.doResize()
            }.bind(this))
        }
        return s.addEventListener("scroll", (function() {
            t && a(t), u = !0, t = r((function() {
                u = !1
            }), 300)
        }), {
            capture: !0,
            ...
            var t = this.sliderElement.querySelector(".n2-ss-slider-background-video");
            t && (n2const.isVideoAutoplayAllowed() ? (t.addEventListener("error", R.bind(null, t), !0), t.load(), t.play()) : R(t))
            ...
            if (this.slider.stages.done("ResizeFirst", function() {
                    ...
                    paddingBottom: 0,
                    paddingLeft: 0
                }, this.alignElement = this.slider.sliderElement.closest(".n2-ss-align"), this.v = this.slider.v, this.containerElementPadding = this.sliderElement.parentNode, this.containerElement = this.containerElementPadding.parentNode, !this.slider.isAdmin && this.parameters.overflowHiddenPage && D([h, n], "overflow", "hidden"), c._smallestZoom = 320, this.initFocusOffsetObserver(), this.slider.stages.resolve("ResponsiveStart"), this.init(), this.parameters.onResizeEnabled) {
            ...
            this.kt = i.innerWidth, this.Ot = i.innerHeight, this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.Dt || (this.Dt = !0, G(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
            ...
            if ("" !== this.parameters.focus.offsetTop) {
                ...
                if (t && t.length)
                    for (var i = new ResizeObserver(function(t) {
                            ...
                            this.Et()
                        }.bind(this)), h = 0; h < t.length; h++) i.observe(t[h])
            }
            ...
            C(this.sliderElement, "--subtract-vertical-offset", (i.n2OffsetTop || this.focusOffsetTop) + (i.n2OffsetBottom || this.focusOffsetBottom) + "px")
            ...
            if (this.parameters.hideOn[f._DeviceMode[t]]) return F(this.v, "n2-section-smartslider--hidden"), !1;
            if (N(this.v, "n2-section-smartslider--hidden"), !this.isVisible) return !1;
            var i = !1,
                s = this.device;
            if (this.deviceID !== t && (this.setDeviceID(t), s && N(this.sliderElement, "n2-ss-" + s), P(this.sliderElement, "deviceMode", this.device), F(this.sliderElement, "n2-ss-" + this.device), this.slider.h("SliderDevice", {
                    lastDevice: s,
                    device: this.device,
                    group: f._DeviceGroup[this.device]
                }), i = !0, this.slider.stages.resolve("Device")), this.slider.isAdmin || "fullpage" === this.parameters.type && (this.Mt = this.getVerticalOffsetHeight(), C(this.sliderElement, "--subtract-vertical-widget", this.Mt + "px")), i && (this.slider.visibleRealSlides = [], this.slider.publicDispatchEvent("SliderDeviceOrientation", {
                    slider: this.slider,
                    lastDevice: s,
                    device: this.device,
                    group: f._DeviceGroup[this.device]
                }), this.slider.stages.resolve("DeviceOrientation"), this.finalizeVisibleSlidesStage1()), !this.slider.visibleRealSlides.length) return this.parameters.hideOn[f._DeviceMode[t]] = !0, F(this.v, "n2-section-smartslider--hidden"), !1;
            if (this.slider.isVisible || this.visibleRealSlidesChanged) {
                for (var h = 0; h < this.slider.realSlides.length; h++) c.MW.i(this.slider.realSlides[h].element).setValues({
                    width: "",
                    height: ""
                }), x(this.slider.realSlides[h].element, {
                    width: "",
                    height: ""
                });
                this.resizeStage1Width(), this.slider.h("SliderResizeHorizontal"), this.resizeStage2Height()
            }
            ...
            }, this.Lt && D(this.sliderElement.querySelectorAll('.n2-ss-layer[data-sstype="slide"] > .n2-ss-layer[data-pm="absolute"][data-adaptivefont="0"]'), "font-size", "calc(" + 16 * this.ratios.slideW + "px * var(--ssfont-scale, 1))");
            for (var t = 0; t < this.slider.realSlides.length; t++) c.MW.i(this.slider.realSlides[t].element).setValues({
            ...
            })), this.updateVisibleSlides(), this.slider.h("visibleRealSlidesChanged"), this.slider.stages.resolve("VisibleRealSlides"), this.isResetActiveSlideEarly && this.calibrateActiveSlide())
            ...
            var i, s;
            t && t !== this.slider.currentRealSlide ? (this.slider.h("BeforeCurrentSlideChange", t), (i = this.slider.currentSlide) && this.slider.forceUnsetActiveSlide(i), this.slider.setCurrentRealSlide(t), s = this.slider.currentSlide, this.targetCurrentSlide = s, this.slider.forceSetActiveSlide(s), this.slider.h("SlideForceChange", {
                oldSlide: i,
                currentSlide: s
            })) : s = this.slider.currentSlide, this.slider.updateInsideSlides([s])
        }, f.prototype.finalizeVisibleSlidesStage2 = function() {
            this.visibleRealSlidesChanged && (this.visibleRealSlidesChanged = !1, this.isResetActiveSlideEarly || this.calibrateActiveSlide(), this.triggerVisibleSlidesChanged(), this.targetCurrentSlide !== o && (this.slider.h("SlideWillChange", {
            ...
            this.slider.h("visibleSlidesChanged"), this.slider.stages.resolve("VisibleSlides"), this.slider.visibleRealSlides.length ? this.slider.isVisible || this.slider.show() : this.slider.isVisible && this.slider.hide()
            ...
            for (var i in this.horizontalSpacing = {
                ...
                for (var s = this.horizontalSpacingControls[i], h = s.length - 1; h >= 0; h--) {
                    var n = s[h];
                    n.isVisible() && (n.refreshSliderSize(t), this.horizontalSpacing[i] += n.getSize())
                }
            return x(this.containerElementPadding, {
        ...
        function s(t, s) {
            if (this._t = t, this.Rt = Array.prototype.slice.call(this._t.querySelectorAll(".n2-ss-animated-heading-i-text")), this.listeners = [], n2Slow || s.disabled.layerAnimations) T(this.Rt.slice(1));
            else {
                this.Tt = c.MW.i(t);
                var h = [];
                this.Rt.forEach((function(t) {
                    h.push(c.MW.i(t))
                })), this.Ft = h, this.slider = s, this.refreshJustifyContent();
                var n = "";
                if (this.Rt.forEach((function(t) {
                        n += t.innerHTML.trim()
                    })), "" !== n) {
                    if (n2const.isParentSameOrigin() && i.parent.tpEditorApp) return D(this.Rt, {
                        position: "static",
                        margin: "0 10px"
                    }), void D(this._t.querySelectorAll(".n2-ss-animated-heading-i2"), "white-space", "normal");
                    this.Nt = [], this.layerElement = this._t.closest(".n2-ss-layer"), this.start()
                }
            }
        }
        return s.prototype.start = function() {
            ...
            this.color = A(this._t, "color") || "RGBA(255,255,255,1)", this.currentType = t[A(this._t, "animationType")] || t.slide, this.currentType.fixedWidth ? this.animateWidth = 0 == +A(this._t, "animateWidth") ? 0 : 1 : this.animateWidth = 0, this.delay = (+A(this._t, "delay") || 0) / 1e3, this.speedModifier = 1 / (Math.max(+A(this._t, "speed") || 100, 0) / 100), this.showDuration = Math.max(+A(this._t, "showDuration") || 1500, 0) / 1e3, this.loop = +A(this._t, "loop") || 0, this.totalDuration = 0;
            ...
            switch (this.loop && h++, this.currentType.fn) {
                case "animateWhole":
                    var n = 0,
                        o = 0;
                    this.animateWidth ? n = .4 * .8 : o = i.overlap * this.speedModifier, this.totalDuration = (h - 1) * this.showDuration + 2 * (h - 1) * i.duration * this.speedModifier + (h - 1) * n - (h - 1) * o;
                    break;
                case "animateTypeWriter":
                    for (var r = 0; r < h; r++) {
                        var a = this.getSplitTextChars(this.Rt[s === r ? 0 : r]);
                        r > 0 && (this.totalDuration += .8 + .2 * this.speedModifier + .2 * this.speedModifier * (a.length - 1)), r < h - 1 && (this.totalDuration += i.backspaceDuration.call(this, a))
                    }
                    break;
                case "animateChars":
                    for (o = 0, r = 0; r < h; r++) {
                        a = this.getSplitTextChars(this.Rt[s === r ? 0 : r]);
                        r > 0 && (this.totalDuration += Math.max(o, i.duration * this.speedModifier + (a.length - 1) * i.stagger)), r < h - 1 && (this.totalDuration += this.showDuration, o = i.duration * this.speedModifier + (a.length - 1) * i.stagger)
                    }
            }
            this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this))), j(this.slider.sliderElement, "SliderResizeHorizontal", function() {
                this.onResize()
            }.bind(this)), this.slider.isAdmin && this.onResize()
        }, s.prototype.onResize = function() {
            var t = {
                height: 0
            };
            this.currentType.fixedWidth && !this.animateWidth && (t.width = 0), S(this.Rt, "n2-ss-animated-heading-measure-width");
            for (var i = 0; i < this.Rt.length; i++) {
                var s = this.Rt[i],
                    h = s.offsetWidth + 1,
                    n = s.offsetHeight;
                P(s, "width", h), P(s, "height", n), t.height = Math.max(t.height, n), this.currentType.fixedWidth && !this.animateWidth && (t.width = Math.max(t.width, h))
            }
            if (I(this.Rt, "n2-ss-animated-heading-measure-width"), this.currentType.fixedWidth && this.animateWidth) {
                let i;
                i = this.slider.isAdmin || this.loop ? this.Rt[0] : this.Rt[this.Rt.length - 1], this.Tt.width = +A(i, "width"), this.Tt.height = t.height, this.invalidate()
            ...
            1 === this.loop ? (this.loopTimeline = new c.AnimationsLoopTimeline(this, 0), i.loop.push(this.loopTimeline)) : i.in.push(new c.AnimationsRelated(this, "extendTimeline"))
        }, s.prototype.getTimeline = function() {
            return this.timeline === o ? (this.timeline = new c.J({
                paused: 1
            ...
            if (!i) {
                var s = c.tt(t, !0);
                t.splitTextChars = i = Array.prototype.filter.call(s.chars, (function(t) {
                    return 0 === t.children.length
                }))
            }
            return i
        }, s.prototype.animateChars = function(t) {
            this.Tt.overflow = "hidden", this.animateWidth && this.timeline.set(this.Tt, {
                width: function() {
                    return A(this, "width")
                }.bind(this.Rt[0]),
                snap: "width",
            ...
            for (var n = 0; n < h; n++) {
                ...
                if (c.MW.t(r, {
                    ...
                    this.timeline.staggerFromTo(r, t.duration * this.speedModifier, d({}, t.from), d({
                        immediateRender: n < s,
                        ease: t.ease
                    }, t.current), t.stagger, a), this.animateWidth && this.timeline.to(this.Tt, this.timeline.recent().duration(), {
                        width: function() {
                            return A(this, "width")
                        }.bind(o)
                    }, a)
                }
                n < h - 1 && (this.timeline.staggerFromTo(r, t.duration * this.speedModifier, d({}, t.current), d({
                    immediateRender: 0 === n,
                    ease: t.ease
                }, t.to), t.stagger, "+=" + this.showDuration), i = this.timeline.recent().duration())
            }
            ...
            var t = l(),
                i = c.MW.i(t);
            t.className = "n2-ss-animated-heading-i-cursor", C(t, "background-color", this.color), this.Rt[0].parentNode.appendChild(t);
            var s = new c.J({
                onComplete: function() {
                    this.restart()
                }
            ...
            for (var h = 0; h < s; h++) {
                ...
                h > 0 && (this.timeline.set(this.Ft[i === h ? 0 : h], {
                    display: "inline-block",
                    immediateRender: i !== h
                }), this.timeline.staggerFromTo(n, .2 * this.speedModifier, {
                    display: "none"
                }, {
                    display: "inline-block",
                    immediateRender: i !== h
                }, .2 * this.speedModifier, "+=0.8")), h < s - 1 && (t.backspace.call(this, n, this.Rt[0].parentNode), this.timeline.set(this.Ft[i === h ? 0 : h], {
                    display: "none",
                    immediateRender: !1
                }))
            }
            ...
            t.overflow ? this.Tt.overflow = "" : this.Tt.overflow = "hidden", this.animateWidth && this.timeline.set(this.Tt, {
                width: function() {
                    return A(this, "width")
                }.bind(this.Rt[0]),
                immediateRender: !0
            }), t.transformOrigin = t.transformOrigin || "50% 50% 0", this.timeline.set(c.MW.X(this.Rt), {
            ...
            for (var h = 0; h < s; h++) {
                ...
                if (h > 0) {
                    ...
                    if (this.animateWidth) {
                        this.timeline.to(this.Tt, .4, {
                            width: function() {
                                return A(this, "width")
                            }.bind(o)
                        }, r - .4 * .2), r += .4 * .8
                    } else r -= t.overlap * this.speedModifier;
                    this.timeline.fromTo(this.Ft[n], t.duration * this.speedModifier, d({}, t.from), d({
                        immediateRender: h < i,
                        ease: t.ease
                    }, t.current), r)
                }
                h < s - 1 && this.timeline.fromTo(this.Ft[n], t.duration * this.speedModifier, d({}, t.current), d({
                    immediateRender: 0 === h,
                    ease: t.ease
        ...
        function t(t, i, h) {
            this.state = {
                ...
                play: !1,
                continuePlay: !1
            }, this.slider = t, this.id = i, this.node = s.getElementById(i), this.audio = this.node.querySelector("audio"), this.audio && (this.layerElement = this.node.closest(".n2-ss-layer"), this.layer = this.node.closest(".n2-ss-layer").layer, this.slide = this.slider.findSlideByElement(this.node), this.isStatic = this.slide.isStatic(), this.isPaused = !1, this.lastVolume = 1, this.parameters = d({
                autoplay: 0,
                loop: 0,
                reset: 0,
                volume: 1,
                show: 1
            }, h), j(this.audio, "play", this.onPlay.bind(this)), j(this.audio, "pause", this.onPause.bind(this)), j(this.audio, "ended", this.onEnded.bind(this)), j(this.audio, "timeupdate", this.onTimeUpdate.bind(this)), n2const.isIOS ? this.prepareIOS() : j(this.audio, "volumechange", this.onVolumechange.bind(this)), this.audio.duration >= 0 ? this.onReady() : this.audio.addEventListener("loadedmetadata", this.onReady.bind(this)))
        }
        return t.prototype.prepareIOS = function() {
            const t = this.node.querySelectorAll(".n2-ss-item-audio-volume-container,.n2-ss-item-audio-mute,.n2-ss-item-audio-unmute");
            T(t)
        }, t.prototype.setState = function(t, i, s) {
            s = s || !1, this.state[t] = i, s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide ? this.safePlay() : this.safePause())
        }, t.prototype.safePlay = function() {
            this.safeCallback(function() {
                this.promise = this.audio.play(), this.promise && Promise !== o && this.promise.catch(function(e) {
                    if ("NotAllowedError" === e.name) var t = function() {
                            B(i), !1 !== this.promise && this.safePlay()
                        }.bind(this),
                        i = [U(n, "click", t), U(n, "touchend", t)]
            ...
            this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
            ...
            this.time = this.node.querySelector(".n2-ss-item-audio-time"), this.updateTime(), this.audio.volume = this.parameters.volume;
            var t = this.node.querySelector(".n2-ss-item-audio-play");
            t && j(t, "click", function() {
                this.setState("play", !0, !0)
            }.bind(this));
            var i = this.node.querySelector(".n2-ss-item-audio-pause");
            i && j(i, "click", function() {
                this.setState("play", !1, !0)
            }.bind(this));
            var s = this.node.querySelector(".n2-ss-item-audio-mute");
            s && j(s, "click", function() {
                this.audio.volume = 0
            }.bind(this));
            var h = this.node.querySelector(".n2-ss-item-audio-unmute");
            h && j(h, "click", function() {
                this.audio.volume = this.lastVolume
            }.bind(this)), this.progress = this.node.querySelector(".n2-ss-item-audio-progress-container"), this.progress && (j(this.progress, "pointerdown", function(e) {
                e.preventDefault(), e.stopPropagation(), this.updateUITime(e);
                var t = [U(n, "pointermove", function(e) {
                    e.preventDefault(), e.stopPropagation(), this.updateUITime(e)
                }.bind(this)), U(n, "pointerup", function(e) {
                    e.preventDefault(), e.stopPropagation(), this.updateUITime(e), B(t)
                }.bind(this)), U(n, "pointerleave", (function() {
                    B(t)
                }))]
            }.bind(this)), this.playhead = this.progress.querySelector(".n2-ss-item-audio-progress-playhead")), this.volume = this.node.querySelector(".n2-ss-item-audio-volume-container"), this.volume && (j(this.volume, "pointerdown", function(e) {
                e.preventDefault(), e.stopPropagation(), this.updateUIVolume(e);
                var t = [U(n, "pointermove", function(e) {
                    e.preventDefault(), e.stopPropagation(), this.updateUIVolume(e)
                }.bind(this)), U(n, "pointerup", function(e) {
                    e.preventDefault(), e.stopPropagation(), this.updateUIVolume(e), B(t)
                }.bind(this)), U(n, "pointerleave", (function() {
                    B(t)
                }))]
            }.bind(this)), this.volumehead = this.volume.querySelector(".n2-ss-item-audio-volumehead")), new ResizeObserver(function(t) {
            ...
            }.bind(this)).observe(this.layer.layer), this.slide.isVisible && this.setState("slideVisible", !0, !0), j(this.slide.element, "Hidden", function() {
                var t = this.state.play;
                this.setState("slideVisible", !1, !0), t && this.setState("continuePlay", !0)
            }.bind(this)), j(this.slide.element, "Visible", function() {
                this.setState("slideVisible", !0, !0)
            }.bind(this)), this.slider.stages.done("BeforeShow", function() {
                this.slide.isActiveWhen() && this.setState("slide", !0, !0)
            }.bind(this)), 1 == +this.parameters.autoplay && this.slider.visible(this.initAutoplay.bind(this)), this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this)), parseInt(this.parameters.reset) && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.audio.currentTime > 0 && !this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]) && (this.audio.currentTime = 0)
            }.bind(this)))
            ...
            this.time && (this.time.innerText = this.timeFormat(this.audio.currentTime) + " / " + this.timeFormat(this.audio.duration))
        }, t.prototype.onPlay = function() {
            this.isPaused = !1, p(this.node, "data-state", "playing"), requestAnimationFrame(this.refreshCurrentTime.bind(this)), this.isStatic || Z(this.slider.sliderElement, "mediaStarted", {
                id: this.id
            }), Y(this.layerElement, "n2play")
        }, t.prototype.onPause = function() {
            this.isPaused = !0, p(this.node, "data-state", "paused"), Y(this.layerElement, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1)
        }, t.prototype.onEnded = function() {
            1 == +this.parameters.loop ? (this.audio.currentTime = 0, this.safePlay()) : (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                id: this.id
            }), Y(this.layerElement, "n2stop"), this.setState("play", !1))
        }, t.prototype.onTimeUpdate = function() {
            this.updateTime(), this.playhead && C(this.playhead, "width", this.audio.currentTime / this.audio.duration * 100 + "%")
        }, t.prototype.onVolumechange = function() {
            this.volumehead && C(this.volumehead, "width", 100 * this.audio.volume + "%"), p(this.node, "data-volume", this.audio.volume), 0 !== this.audio.volume && (this.lastVolume = this.audio.volume)
        }, t.prototype.refreshCurrentTime = function() {
            this.playhead && C(this.playhead, "width", this.audio.currentTime / this.audio.duration * 100 + "%"), this.isPaused || requestAnimationFrame(this.refreshCurrentTime.bind(this))
        }, t.prototype.updateUITime = function(e) {
            var t = this.progress.getBoundingClientRect();
            this.audio.currentTime = this.audio.duration * Math.max(0, Math.min(.99, Math.round(e.clientX - t.left) / t.width))
        }, t.prototype.updateUIVolume = function(e) {
            var t = this.volume.getBoundingClientRect();
            this.audio.volume = Math.max(0, Math.min(1, Math.round(e.clientX - t.left) / t.width))
        ...
        class t {
            ...
            qt() {
                ...
                "ontouchstart" in i && (this.Vt.classList.add("n2-ss-item-ba-container-touchaction"), t = "pointerdown"), this.Vt.addEventListener(t, (e => {
                    if (!e.isPrimary || "drag" === this.zt && 0 !== e.button) return;
                    let t = [],
                        s = 0,
                        h = !1;
                    n2const.isIOS && i.TouchEvent && t.push(U(this.Vt, "touchmove", (i => {
                        s++, s > 5 && (!h && this.__preventTouchAction(e, i) ? B(t) : (i.preventDefault(), h = !0))
                    }))), this.setMoveEvents(e), t.push(U(n, "pointermove", (e => {
                        e.isPrimary && this.setMoveEvents(e)
                    }))), t.push(U(n, "pointerup", (e => {
                        e.isPrimary && 0 === e.button && "hover" !== this.zt && (this.Qt(e), B(t))
                    }))), t.push(U(n, "pointercancel", (e => {
                        e.isPrimary && (this.Qt(e), B(t))
                    }))), t.push(U(this.Vt, "pointerleave", (e => {
            ...
            Qt(e) {
                e && "pointermove" === e.type ? F(this.Vt, "divider-moving") : N(this.Vt, "divider-moving")
            }
            Ht() {
                this.Bt && "hover" === this.Wt && i.matchMedia("(hover: none)").matches && this.Bt.forEach((t => {
                    N(t, "n2-ss-item-ba-label--show-hover"), F(t, "n2-ss-item-ba-label--show-normal")
                })), this.Ut && "hover" === this.Yt && i.matchMedia("(hover: none)").matches && (N(this.Ut, "n2-ss-item-ba-caption--show-hover"), F(this.Ut, "n2-ss-item-ba-caption--show-normal"))
            }
            setMoveEvents(e) {
                this.Qt(e)
            }
        ...
        class h extends t {
            setMoveEvents(e) {
                ...
                this.Xt.xP = s, this.jt.clipPath = "inset(0 0 0 " + s + "%)", this.Gt.clipPath = "inset(0 calc(" + (100 - s) + "% - .5px) 0 0 )"
            }
            __isScrollable(t, i) {
        ...
        class o extends t {
            setMoveEvents(e) {
                ...
                const t = this.Vt.getBoundingClientRect(),
                    ...
                    s = Math.max(0, Math.min(100, i));
                this.Xt.yP = s, this.jt.clipPath = "inset(" + s + "% 0 0 0)", this.Gt.clipPath = "inset(0 0  calc(" + (100 - s) + "% - .5px) 0)"
            }
            __isScrollable(t, i) {
                return Math.abs(t) > Math.abs(i)
            }
        ...
        function t(t, i, h, n, o, r) {
            ...
            a.addEventListener("pointerenter", this.si.bind(this)), a.addEventListener("pointerleave", this.hi.bind(this)), this.ni = c.MW.i(a.querySelector("img")), this.ei = a.querySelector(".n2-ss-item-caption-content"), this.oi = c.MW.i(this.ei), "Fade" === h ? (this.oi.setValues({
                opacity: 0
            }), this.ri = this.ai, this.ci = this.ui) : (this.fi = {}, this.fi[this.ut] = this.ti, this.oi[this.ut] = this.ti)
        }
        return t.prototype.si = function() {
            this.ri(), this.ii && this.li({
                scale: 1.2
            })
            ...
            c.K.to(this.oi, .5, d(t))
        }, t.prototype.li = function(t) {
            c.K.to(this.ni, .5, d(t))
        }, t
    })), c.d("FrontendItemCountdown", (function() {
        function t(t, i) {
            this.slider = i, this.listeners = [], this.mi = t, this.vi = A(this.mi, "timestamp"), this.layerElement = this.mi.closest(".n2-ss-layer"), this.start()
        }
        return t.prototype.start = function() {
            this.slider.started(this.started.bind(this))
        }, t.prototype.started = function() {
            this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.animate.bind(this)))
        }, t.prototype.animate = function() {
            this.second = this.layerElement.querySelector(".n2-ss-item-countdown_second .n2-ss-item-countdown_number"), this.minute = this.layerElement.querySelector(".n2-ss-item-countdown_minute .n2-ss-item-countdown_number"), this.hour = this.layerElement.querySelector(".n2-ss-item-countdown_hour .n2-ss-item-countdown_number"), this.day = this.layerElement.querySelector(".n2-ss-item-countdown_day .n2-ss-item-countdown_number"), u(this.onUpdate.bind(this))
        }, t.prototype.onUpdate = function() {
            let t = Math.max(0, this.vi - Math.floor((new Date).getTime() / 1e3));
            0 === t ? this.doAction() : (this.refresh(t), this.pi = u(this.onUpdate.bind(this)))
            ...
            const h = Math.floor(t / 60),
                n = t -= 60 * h;
            this.bi !== i && (this.bi = i, this.day.innerText = this.formatNumber(i)), this.yi !== s && (this.yi = s, this.hour.innerText = this.formatNumber(s)), this.wi !== h && (this.wi = h, this.minute.innerText = this.formatNumber(h)), this.gi !== n && (this.gi = n, this.second.innerText = this.formatNumber(n))
        }, t.prototype.formatNumber = function(t) {
            return t < 10 ? "0" + t : t
        }, t
    })), c.d("FrontendItemCounter", (function() {
        function t(t, i, h) {
            this.slider = t, this.data = h, this.currentPercent = this.data.fromPercent, this.listeners = [];
            var n = s.getElementById(i);
            n.ssCounter = this, this.layerElement = n.closest(".n2-ss-layer"), this.data.displayMode && (this.display = n.querySelector(this.data.display)), this.countingDiv = n.querySelector(this.data.counting), this.data.duration > 0 && this.start()
        }
        return t.prototype.start = function() {
            this.slider.started(this.started.bind(this))
        }, t.prototype.started = function() {
            this.delay = (+this.data.delay || 0) / 1e3, this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this))), this.timeline = new c.J({
                paused: 1
            });
            ...
            this.timeline.fromTo(i, this.data.duration / 1e3, {
                percent: this.data.fromPercent
            }, this._animateData(this.data.toPercent))
        }, t.prototype.collectRelatedAnimations = function(t) {
            t.relatedAnimations.in.push(new c.AnimationsRelated(this, "extendTimeline"))
            ...
            this.countingDiv.innerHTML = this.data.pre + (this.data.min + t * (this.data.total - this.data.min)).toFixed(0) + this.data.post
        ...
        function t(t, s) {
            this.slider = s, this.mi = t, this.wrapper = this.mi.parentNode, this.listeners = [], this.refreshJustifyContent(), j(this.slider.sliderElement, "SliderResize", this.refreshJustifyContent.bind(this)), this.layerElement = this.mi.closest(".n2-ss-layer"), this.clean(), n2Slow || s.disabled.layerAnimations || !A(this.mi, "animate") || n2const.isParentSameOrigin() && i.parent.tpEditorApp || (this.wrapper.querySelectorAll(".n2-ss-highlighted-heading-before,.n2-ss-highlighted-heading-after").forEach((function(t) {
                var i, s = t.innerHTML.split(" "),
                    h = t.className,
                    n = new DocumentFragment;
                "n2-ss-highlighted-heading-after" === h && s.unshift("");
                for (var o = 0; o < s.length; o++)(i = l()).className = h, i.innerHTML = s[o] + "&nbsp;", n.appendChild(i);
        ...
        return t.prototype.clean = function() {}, t.prototype.start = function() {
            ...
            this.delay = (+A(this.mi, "delay") || 0) / 1e3, this.duration = Math.max(+A(this.mi, "duration") || 1500, 1) / 1e3, this.loop = +A(this.mi, "loop") || 0;
            var t = +A(this.mi, "loopDelay");
            isFinite(t) || (t = 2e3), this.loopDelay = t / 1e3, this.paths = this.mi.querySelectorAll("path"), this.totalDuration = .6 * this.duration * (this.paths.length - 1) + this.duration, this.loop && this.loopDelay >= 0 && (this.totalDuration += this.loopDelay + .8), this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this)))
        }, t.prototype.collectRelatedAnimations = function(t) {
            var i = t.relatedAnimations;
            1 === this.loop ? i.loop.push(new c.AnimationsLoopTimeline(this, 0)) : i.in.push(new c.AnimationsRelated(this, "extendTimeline"))
            ...
            if (this.timeline === o) {
                for (var t = new c.J({
                        paused: 1
                    }), i = 0; i < this.paths.length; i++) this.animatePath(t, this.paths[i], .6 * this.duration * i);
                this.loop && this.loopDelay >= 0 && (t.to(c.MW.L(this.paths), .4, {
                    opacity: 0
            ...
            var t = "";
            switch (i.getComputedStyle(this.wrapper).getPropertyValue("text-align")) {
                case "left":
                    t = "flex-start";
                    break;
                case "center":
        ...
        function i(t, i, h, n, r, a, c, u) {
            if (!(n2Slow || t.disabled.layerAnimations || t.disabled.layerSplitTextAnimations || !r && !c)) {
                this.node = s.getElementById(i), this.slider = t, this.splitText = !1, this.listeners = [];
                var f = this.node.querySelector("a.n2-ow");
                f && (this.node = f), this.layerElement = this.node.closest(".n2-ss-layer"), this.in = {
                    options: !1,
                    totalDuration: 0,
                    timeline: o,
                    invalidate: !1
        ...
        return i.prototype.start = function(t, i, s, h, n, o) {
            ...
            if (s && (this.in.options = this.optimize(s.data, h), u[this.in.options.mode] = 1), n && (this.out.options = this.optimize(n.data, o), u[this.out.options.mode] = 1), this.splitText = c.tt(this.node, u.chars), this.in.options) {
            ...
            for (var f in (this.in.options || this.out.options) && this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this))), c.MW.i(this.layerElement).perspective = 1e3, this.node.textRendering = "auto", u) u[f] && c.MW.X(this.splitText[f]).setValues({
                "transform-origin": t,
                "backface-visibility": i
            })
        }, i.prototype.getTimelineIn = function() {
            this.in.timeline = new c.J({
                paused: 1
            });
            ...
            return this._animate(this.in.timeline, i.mode, i.sort, i.duration, m({}, i.from), d(s, t), i.stagger), this.in.timeline
        }, i.prototype.getTimelineOut = function() {
            this.out.timeline = new c.J({
                paused: 1
            });
            ...
            return this.in.timeline && (s.immediateRender = !1), this._animate(this.out.timeline, i.mode, i.sort, i.duration, m({}, t), d(s, i.from), -i.stagger), this.out.timeline
        }, i.prototype.collectRelatedAnimations = function(t) {
            var i = t.relatedAnimations;
            this.in.options && i.in.push(new c.AnimationsRelated(this, "extendTimelineIn")), this.out.options && i.out.push(new c.AnimationsRelated(this, "extendTimelineOut"))
            ...
            switch (s) {
                ...
                case "random":
                    ! function(t, i, s, h) {
                        for (s = t.length; s;) i = Math.random() * s-- | 0, h = t[s], t[s] = t[i], t[i] = h
                    }(a);
                    break;
                case "side":
                case "center":
                    for (u = []; a.length > 1;) f.push(a.shift()), u.push(a.pop());
                    1 === a.length && f.push(a.shift()), a = f, "center" === s && (a.reverse(), u.reverse());
                    break;
                case "sideShifted":
                case "centerShifted":
                    for (; a.length > 1;) f.push(a.shift()), f.push(a.pop());
                    1 === a.length && f.push(a.shift()), a = f, "centerShifted" === s && a.reverse()
            }
            t.staggerFromTo(c.MW.L(a), h, n, o, r, 0), u && u.length && t.staggerFromTo(c.MW.L(u), h, n, o, r, 0)
            ...
            return 1 != t.opacity && (s.from.opacity = t.opacity), 1 != t.scale && (s.from.scale = t.scale), 0 != t.x && (s.from.x = t.x), 0 != t.y && (s.from.y = t.y), 0 != t.rotationX && (s.from.rotationX = t.rotationX), 0 != t.rotationY && (s.from.rotationY = t.rotationY), 0 != t.rotationZ && (s.from.rotationZ = t.rotationZ), s
        }, i
    })), c.d("FrontendItemTransition", (function() {
        function t(t, i, h) {
            this.slider = t, this.animation = h;
            var n = s.getElementById(i);
            j(n, "mouseenter", this["in" + h].bind(this)), j(n, "mouseleave", this["out" + h].bind(this)), this.Si = c.MW.L(n.querySelectorAll("img")), this.Ii = c.MW.i(n.querySelector(".n2-ss-item-transition-inner")), this["init" + h]()
        }
        return t.prototype.initFade = function() {
            this.Si[1].opacity = 0
            ...
            this.Ii.perspective = 1e3, this.Si[0].transformPerspective = 1e3, this.Si[1].transformPerspective = 1e3, this.Si[0].rotationX = 0, this.Si[0].backfaceVisibility = "hidden", this.Si[1].rotationX = 180, this.Si[1].backfaceVisibility = "hidden"
            ...
            this.Ii.perspective = 1e3, this.Si[0].transformPerspective = 1e3, this.Si[1].transformPerspective = 1e3, this.Si[0].rotationY = 0, this.Si[0].backfaceVisibility = "hidden", this.Si[1].rotationY = 180, this.Si[1].backfaceVisibility = "hidden"
        ...
        function i(i, h, n, o) {
            this.state = {
                ...
                play: !1,
                continuePlay: !1
            }, this.counter = t++, this.slider = i, this.playerId = h, this.playerElement = s.getElementById(this.playerId), this.parameters = d({
                autoplay: 0,
                loop: 0,
                reset: 0
            }, n), this.slide = i.findSlideByElement(this.playerElement), this.isStatic = this.slide.isStatic(), this.cover = this.playerElement.parentNode.querySelector(".n2_ss_video_player__cover");
            var r = +A(this.playerElement, "volume");
            0 === r ? (this.playerElement.volume = 1, this.playerElement.muted = !0) : (this.playerElement.volume = r, this.playerElement.muted = !1), this.slider.stages.done("BeforeShow", this.initVideoPlayer.bind(this))
        }
        return i.prototype.fadeOutCover = function() {
            this.coverFadedOut === o && this.cover && (this.coverFadedOut = !0, c.K.to(c.MW.i(this.cover), .3, {
                opacity: 0,
                onComplete: function() {
                    R(this.cover)
                }.bind(this)
            ...
            "fill" === A(this.playerElement.parentNode, "aspectRatio") && this.slider.responsive.doThrottledResize();
            var t = this.playerElement.closest(".n2-ss-layer");
            this.layer = t.layer, new ResizeObserver(function(t) {
                var i = t[0].contentRect;
                if (i.width && i.height) this.state.visible || this.setState("visible", !0, !0);
                else if (this.state.visible) {
                    var s = this.state.play;
            ...
            }.bind(this)).observe(t), this.slide.isVisible && this.setState("slideVisible", !0, !0), j(this.slide.element, "Hidden", function() {
                var t = this.state.play;
                this.setState("slideVisible", !1, !0), t && this.setState("continuePlay", !0)
            }.bind(this)), j(this.slide.element, "Visible", function() {
                this.setState("slideVisible", !0, !0)
            }.bind(this)), j(this.playerElement, "playing", function() {
                this.isStatic || Z(this.slider.sliderElement, "mediaStarted", {
                    id: this.playerId
                }), Y(t, "n2play")
            }.bind(this)), j(this.playerElement, "ended", function() {
                1 !== parseInt(this.parameters.loop) && (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                    id: this.playerId
                }), Y(t, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s), this.slider.next(!0)))
            }.bind(this)), j(this.playerElement, "pause", function() {
                Y(t, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1)
            }.bind(this)), this.slide.isActiveWhen() && this.setState("slide", !0, !0), 1 === parseInt(this.parameters.autoplay) && this.slider.visible(this.initAutoplay.bind(this)), this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this)), parseInt(this.parameters.reset) && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.playerElement.currentTime > 0 && !this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]) && (this.playerElement.currentTime = 0)
            }.bind(this))), "" !== this.parameters["scroll-pause"] ? c.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
                this.setState("scroll", !0, !0)
            }.bind(this), function() {
                this.setState("continuePlay", !0), this.setState("scroll", !1, !0)
            }.bind(this)) : this.setState("scroll", !0, !0), this.cover && (G(this.cover, "click", this.safePlay.bind(this)), G(t, "n2play", this.fadeOutCover.bind(this)))
        }, i.prototype.onCurrentSlideChange = function(t) {
            var i = this.slide.isActiveWhen(t);
            i && 1 == this.parameters.autoplay && this.setState("play", !0), this.setState("slide", i, !0)
        }, i.prototype.initAutoplay = function() {
            this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]) ? (this.setState("play", !0), r(function() {
                    this.setState("slide", !0, !0)
                }.bind(this), 100)) : this.setState("slide", !1, !0)
            }.bind(this)), this.slide.isActiveWhen() && (this.setState("play", !0), this.setState("slide", !0, !0)))
        }, i.prototype.setState = function(t, i, s) {
            s = s || !1, this.state[t] = i, s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide && this.state.scroll ? this.safePlay() : this.safePause())
        }, i.prototype.safePlay = function() {
            this.safeCallback(function() {
                this.playerElement.readyState < 4 && this.playerElement.load(), this.promise = this.playerElement.play(), this.promise && Promise !== o && this.promise.catch(function(e) {
                    if ("NotAllowedError" === e.name) var t = function() {
                            B(i), !1 !== this.promise && this.safePlay()
                        }.bind(this),
                        i = [U(n, "click", t), U(n, "touchend", t)]
        ...
        return t.prototype.whenLoaded = function() {
            1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile ? this.ready(this.initVimeoPlayer.bind(this)) : this.ready(function() {
                var t = function(e) {
                        B(i), e.preventDefault(), e.stopPropagation(), this.initVimeoPlayer(), this.safePlay()
                    }.bind(this),
                    i = [U(this.playerElement, "click", t), U(this.playerElement, "n2click", t)]
            }.bind(this))
        }, t.prototype.ready = function(t) {
            ...
            var t = f("iframe");
            t.className = "intrinsic-ignore", t.allow = "fullscreen; autoplay; encrypted-media", t.id = this.playerId + "-frame", t.src = "https://player.vimeo.com/video/" + this.parameters.vimeocode + "?autoplay=0&_video&title=" + this.parameters.title + "&byline=" + this.parameters.byline + "&background=" + this.parameters.background + "&portrait=" + this.parameters.portrait + "&color=" + this.parameters.color + "&loop=" + this.parameters.loop + ("-1" == this.parameters.quality ? "" : "&quality=" + this.parameters.quality) + "&dnt=" + this.parameters["privacy-enhanced"] + ("" !== this.parameters.privateid ? "&h=" + this.parameters.privateid : ""), t.webkitAllowFullScreen = !0, t.allowFullScreen = !0, x(t, {
                position: "absolute",
                top: 0,
                left: 0,
                width: "100%",
            ...
            this.layer = i.layer, new ResizeObserver(function(t) {
                ...
                this.setState("slideVisible", !0, !0)
            }.bind(this)), this.cover && (n2const.isMobile && G(this.cover, "click", this.safePlay.bind(this)), G(i, "n2play", function() {
                c.K.to(c.MW.i(this.cover), .3, {
                    opacity: 0,
                    onComplete: function() {
                        R(this.cover)
                    }.bind(this)
                ...
                Y(i, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1)
            }.bind(this)), this.player.on("ended", function() {
                this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                    id: this.playerId
                }), Y(i, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && 0 == this.parameters.loop && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s), this.slider.next(!0))
            }.bind(this)), this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this))), "" !== this.parameters["scroll-pause"] ? c.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
            ...
            }.bind(this)), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]) ? (this.setState("play", !0), this.setState("slide", !0, !0)) : this.setState("slide", !1, !0)
            }.bind(this)), this.slide.isActiveWhen() && (this.setState("play", !0), this.setState("slide", !0, !0)))
        }, t.prototype.setState = function(t, i, s) {
            s = s || !1, this.state[t] = i, s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide && this.state.InComplete && this.state.scroll && this.layer.isVisible ? this.play() : this.pause(), this.state.slideVisible && this.state.visible && this.state.slide && this.layer.isVisible ? y(this.player.element, "tabindex") : p(this.player.element, "tabindex", "-1"))
        }, t.prototype.play = function() {
        ...
        function t(t, i, h, n) {
            this.state = {
                ...
                this._resolve = t
            }.bind(this)), this.slider = t, this.playerId = i, this.playerElement = s.getElementById(this.playerId), this.cover = this.playerElement.querySelector(".n2_ss_video_player__cover"), this.hasImage = n, this.parameters = d({
                ...
                query: [],
                playsinline: 0
            }, h), n2const.isLighthouse || c.r("windowLoad", this.whenLoaded.bind(this))
        }
        var h;
        return t.prototype.whenLoaded = function() {
            if (1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile) this.ready(this.initYoutubePlayer.bind(this));
                    ...
                    B(i), e.preventDefault(), e.stopPropagation(), this.ready(function() {
                        this.promise.then(this.play.bind(this)), this.initYoutubePlayer()
                    }.bind(this))
                }.bind(this),
                i = [U(this.playerElement, "click", t), U(this.playerElement, "n2click", t)]
        }, t.prototype.ready = function(t) {
            if (!h && (h = new Promise((function(t) {
                    var s;
                ...
                var n = f("script");
                n.src = "https://www.youtube.com/iframe_api", s.head.appendChild(n)
            }
            h.then(t)
            ...
            var t = this.playerElement.closest(".n2-ss-layer");
            this.layer = t.layer, this.cover && (n2const.isMobile && G(this.cover, "click", this.play.bind(this)), G(t, "n2play", this.fadeOutCover.bind(this))), this.slide = this.slider.findSlideByElement(this.playerElement), this.isStatic = this.slide.isStatic();
            var h = {
                enablejsapi: 1,
            ...
            if (1 === parseInt(this.parameters.autoplay))
                ...
                this.parameters.autoplay = 0;
                try {
                    "playsInline" in f("video") && (this.parameters.autoplay = 1, this.parameters.volume = 0, h.playsinline = 1)
                } catch (t) {}
            }
            for (var n in n2const.isIOS && this.parameters.controls && (h.use_native_controls = 1), 1 == this.parameters.center && (h.controls = 0), 1 != this.parameters.controls && (h.autohide = 1, h.controls = 0), +(navigator.platform.toUpperCase().indexOf("MAC") >= 0 && navigator.userAgent.search("Firefox") > -1) && (h.html5 = 1), this.parameters.query) this.parameters.query.hasOwnProperty(n) && (h[n] = this.parameters.query[n]);
            var o = {
                    ...
                    onStateChange: function(i) {
                        switch (i.data) {
                            ...
                            case YT.PlayerState.BUFFERING:
                                this.isStatic || this.slide.isActiveWhen(this.slider.currentSlide) && Z(this.slider.sliderElement, "mediaStarted", {
                                    id: this.playerId
                                }), Y(t, "n2play");
                                break;
                            ...
                            case YT.PlayerState.ENDED:
                                1 == this.parameters.loop ? (this.player.seekTo(this.parameters.start), this.player.playVideo()) : (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                                    id: this.playerId
                                }), Y(t, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s), this.slider.next(!0)))
                        }
                    }.bind(this)
            ...
            (this.parameters["privacy-enhanced"] || i.jQuery && i.jQuery.fn.revolution) && (o.host = "https://www.youtube-nocookie.com"), this.player = new YT.Player(this.playerId + "-frame", o), 1 == this.parameters.center && (C(this.playerElement.parentNode, "overflow", "hidden"), this.onResize(), j(this.slider.sliderElement, "SliderResize", this.onResize.bind(this)))
        }, t.prototype.onReady = function() {
            ...
            t > 0 ? this.setVolume(t) : -1 !== t && this.player.mute(), new ResizeObserver(function(t) {
                ...
                this.setState("slideVisible", !0, !0)
            }.bind(this)), this.slide.isActiveWhen() && this.setState("slide", !0, !0), 1 == this.parameters.autoplay && this.slider.visible(this.initAutoplay.bind(this)), this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this)), parseInt(this.parameters.reset) && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
            ...
            }.bind(this))), this._resolve(), "" !== this.parameters["scroll-pause"] ? c.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
                this.setState("scroll", !0, !0)
            }.bind(this), function() {
                this.setState("continuePlay", !0), this.setState("scroll", !1, !0)
            ...
            n[n2const.rtl["margin-left"]] = 0, i / s > h ? (n.height = i * h + "px", n["margin-top"] = (s - i * h) / 2 + "px") : (n.width = s * h + "px", n[n2const.rtl["margin-left"]] = (i - s * h) / 2 + "px"), x(this.playerElement, n)
        }, t.prototype.initAutoplay = function() {
            this.layer.addStateCallback(function(t) {
                this.setState("InComplete", t.InComplete, !0)
            }.bind(this)), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
            ...
            this.isStopped() && (this.coverFadedOut === o && r(this.fadeOutCover.bind(this), 200), Z(this.slider.sliderElement, "mediaStarted", {
                id: this.playerId
